...
#SBATCH -o /global/home/users/makman/vcftools/outs/vcftools_filter_all.out
#SBATCH -e /global/home/users/makman/vcftools/outs/vcftools_filter_all.err
