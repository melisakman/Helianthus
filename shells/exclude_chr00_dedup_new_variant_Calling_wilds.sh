...
#SBATCH --mem=32000
#SBATCH -o ../outs/filter_chr00_new_VC_bams.out
#SBATCH -e ../outs/filter_chr00_new_VC_bams.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All

module load samtools/1.3.1

# srun samtools view -b -b HT013_SD2W-18.sort.dup.realign.bam -L ./chr_group.txt > HT013_SD2W-18.sort.dup.realign_nochr00.bam
