...
java -Xmx32G -jar /clusterfs/vector/scratch/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
    ...
    -I HT55_IA2W-17.sort.dup.realign_nochr00_dedup.bam \
    -L HanXRQChr01 \
...
java -Xmx32G -jar /clusterfs/vector/scratch/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
    ...
    -o /clusterfs/vector/scratch/makman/haplotype_networks/bams/bam_recal/HT55_IA2W-17.sort.dup.realign_nochr00_dedup_recal.bam
