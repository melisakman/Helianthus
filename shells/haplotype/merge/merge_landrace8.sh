...
#SBATCH --time=6:00:00
#SBATCH --mem=48000
#SBATCH -o /clusterfs/vector/scratch/makman/haplotype_networks/outs/merge_new_VC_lr8.out
#SBATCH -e /clusterfs/vector/scratch/makman/haplotype_networks/outs/merge_new_VC_lr8.err
