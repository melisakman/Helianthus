...
#SBATCH --time=5:00:00
#SBATCH --mem=32000
#SBATCH -o ../outs/base_calibrate_chr00_new_VC1.out
#SBATCH -e ../outs/base_calibrate_chr00_new_VC1.err
...
#     -I HT013_SD2W-18.sort.dup.realign_nochr00_dedup_reGroups.bam \
#     -L HanXRQChr01 \
...
#     -o /clusterfs/vector/scratch/makman/haplotype_networks/bams/bam_recal/tables/HT013_SD2W-18.sort.dup.realign_nochr00_dedup.table
...
java -Xmx32G -jar /clusterfs/vector/scratch/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
    ...
    -o /clusterfs/vector/scratch/makman/haplotype_networks/bams/bam_recal/HT013_SD2W-18_dedup_recal.bam
