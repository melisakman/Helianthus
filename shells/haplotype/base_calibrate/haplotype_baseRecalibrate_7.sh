...
java -Xmx32G -jar /clusterfs/vector/scratch/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
    ...
    -I HT254_KS1W-27.sort.dup.realign_nochr00_dedup_reGroups.bam \
    -L HanXRQChr01 \
    ...
    -o /clusterfs/vector/scratch/makman/haplotype_networks/bams/bam_recal/tables/HT254_KS1W-27.sort.dup.realign_nochr00_dedup.table

java -Xmx32G -jar /clusterfs/vector/scratch/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
    -T PrintReads \
    -R /clusterfs/vector/scratch/makman/haplotype_networks/HanXRQr1.0-20151230_no_Chr00.fasta \
    -I HT254_KS1W-27.sort.dup.realign_nochr00_dedup_reGroups.bam \
    -BQSR /clusterfs/vector/scratch/makman/haplotype_networks/bams/bam_recal/tables/HT254_KS1W-27.sort.dup.realign_nochr00_dedup.table \
    -o /clusterfs/vector/scratch/makman/haplotype_networks/bams/bam_recal/HT254_KS1W-27.sort.dup.realign_nochr00_dedup_recal.bam
