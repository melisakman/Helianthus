...
#SBATCH --mem=64000
#SBATCH -o ../outs/calibrate_new_VC9_4.out
#SBATCH -e ../outs/calibrate_new_VC9_4.err
...
# 	-o /clusterfs/vector/scratch/makman/haplotype_networks/bams/bam_recal/Havasupai_dedup_recab.bam
...
java -Djava.io.tmpdir=/clusterfs/vector/scratch/makman/tempor1/ -Xmx32G -jar /clusterfs/vector/scratch/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
	...
	-o /clusterfs/vector/scratch/makman/haplotype_networks/bams/bam_recal/Hidatsa1_dedup_recab.bam
# java -Djava.io.tmpdir=/clusterfs/vector/scratch/makman/tempor1/ -Xmx32G -jar /clusterfs/vector/scratch/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
#     -T PrintReads \
#     -R /clusterfs/vector/scratch/makman/haplotype_networks/HanXRQr1.0-20151230_no_Chr00.fasta \
