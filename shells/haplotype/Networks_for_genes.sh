...
#SBATCH --mem=32000
#SBATCH -o /clusterfs/vector/scratch/makman/haplotype_networks/outs/haplotypes_new_VC_Melis.out
#SBATCH -e /clusterfs/vector/scratch/makman/haplotype_networks/outs/haplotypes_new_VC_Melis.err
...
Total_lines=`grep -c "^" MelisGenes.bed`
...
do
  ...
  sed "${Line_to_read}q;d" MelisGenes.bed > Current_gene_tested.bed;
...
#    --variant /clusterfs/vector/scratch/makman/haplotype_networks/Haplo_by_gene/gVCF_samples/raw.snps.indels_${var_current_gene_name}_annNM.g.vcf \
...
#       -o /clusterfs/vector/scratch/makman/h
#       aplotype_networks/Haplo_by_gene/VCF_readback/phased_${var_current_gene_name}_${Var_current_sample}.vcf \
#       -L Current_gene_tested.bed \
