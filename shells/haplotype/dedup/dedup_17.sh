...
#SBATCH --mem=48000
#SBATCH -o /clusterfs/vector/scratch/makman/haplotype_networks/outs/dedup_17.out
#SBATCH -e /clusterfs/vector/scratch/makman/haplotype_networks/outs/dedup_17.err
