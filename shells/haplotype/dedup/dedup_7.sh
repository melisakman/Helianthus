...
#SBATCH --mem=48000
#SBATCH -o /clusterfs/vector/scratch/makman/haplotype_networks/outs/dedup_7.out
#SBATCH -e /clusterfs/vector/scratch/makman/haplotype_networks/outs/dedup_7.err
