...
#SBATCH --mem=48000
#SBATCH -o /clusterfs/vector/scratch/makman/haplotype_networks/outs/dedup_15.out
#SBATCH -e /clusterfs/vector/scratch/makman/haplotype_networks/outs/dedup_15.err
