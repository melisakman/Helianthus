...
#SBATCH --mem=48000
#SBATCH -o /clusterfs/vector/scratch/makman/haplotype_networks/outs/dedup_1.out
#SBATCH -e /clusterfs/vector/scratch/makman/haplotype_networks/outs/dedup_1.err
