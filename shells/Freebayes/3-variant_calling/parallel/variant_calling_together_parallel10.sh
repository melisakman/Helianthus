...
./freebayes-parallel /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa.100kbp.regions 12 -f /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -r HanXRQChr10 /clusterfs/rosalind/users/makman/GATK/bams/Anzac_Pueblo_sorted_markdup_recal_RG.bam \
...
/clusterfs/rosalind/users/makman/GATK/bams/Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam > /clusterfs/rosalind/users/makman/GATK/freebayes/freebayes_combined_chr10_p.vcf
