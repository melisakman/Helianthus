...
./freebayes-parallel /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa.20mbp.regions 12 -f /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -r HanXRQChr03 /clusterfs/rosalind/users/makman/GATK/bams/Anzac_Pueblo_sorted_markdup_recal_RG.bam \
