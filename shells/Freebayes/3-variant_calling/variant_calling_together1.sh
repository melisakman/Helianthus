...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_combined_chr01_v2.out
#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_combined_chr01_v2.err
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam > ../freebayes/freebayes_combined_chr01_v2.vcf
