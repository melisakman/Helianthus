...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_invariant_chr""" + str(chr) + "_secondtime_chunk" + str(i) + ".out" +
"""\n#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_invariant_chr""" + str(chr) +"_secondtime_chunk" + str(i) + ".err" +
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam > ../freebayes/freebayes_invariant_chr""" + str(chr) + "_secondtime_chunk" + str(i) + ".vcf")
