...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_invariant_chr05_secondtime_chunk32.out
#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_invariant_chr05_secondtime_chunk32.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
module load freebayes/v1.1.0-56-ga180635
TMPDIR=/clusterfs/rosalind/users/makman/temp

freebayes -f /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa --report-monomorphic -r HanXRQChr05:124000001-128000000 \
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam > ../freebayes/freebayes_invariant_chr05_secondtime_chunk32.vcf