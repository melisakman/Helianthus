...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_invariant_chr08_chunk8_1.out
#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_invariant_chr08_chunk8_1.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
module load freebayes/v1.1.0-56-ga180635
TMPDIR=/clusterfs/rosalind/users/makman/temp

freebayes -f /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa --report-monomorphic -r HanXRQChr08:56000001-64000000\
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam > ../freebayes/freebayes_invariant_chr08_chunk8b.vcf