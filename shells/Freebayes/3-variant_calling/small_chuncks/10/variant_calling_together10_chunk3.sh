...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_combined_chr10_chunk3.out
#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_combined_chr10_chunk3.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
module load freebayes/v1.1.0-56-ga180635
TMPDIR=/clusterfs/rosalind/users/makman/temp
freebayes -f /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -r HanXRQChr10:119465494-129465493 Anzac_Pueblo_sorted_markdup_recal_RG.bam \
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam > ../freebayes/freebayes_combined_chr10_chunk3.vcf
