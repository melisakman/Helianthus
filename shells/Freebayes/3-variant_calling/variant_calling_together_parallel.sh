...
export PATH=$PATH:/clusterfs/vector/home/groups/software/sl-7.x86_64/modules/vcflib/1.0.0/bin
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam > ../freebayes/freebayes_combined_chr01_p.vcf
