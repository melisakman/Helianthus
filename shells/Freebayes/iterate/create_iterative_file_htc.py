...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam > ../freebayes/freebayes_invariant_chr""" + str(chr) + "_chunk" + str(i) + ".vcf")
	border_l = border_l + 8000000
	border_r = border_r + 8000000
