...
bcftools merge -m all -O z freebayes_invariant_chr13_combined.vcf.gz freebayes_invariant_chr13_AnzacPueblo_all.vcf.gz > freebayes_invariant_chr13_all.vcf.gz
