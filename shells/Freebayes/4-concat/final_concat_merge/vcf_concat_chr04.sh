...
bcftools merge -m all -O z freebayes_invariant_chr04_combined.vcf.gz freebayes_invariant_chr04_AnzacPueblo_all.vcf.gz > freebayes_invariant_chr04_all.vcf.gz