...
bcftools merge -m all -O z freebayes_invariant_chr12_combined.vcf.gz freebayes_invariant_chr12_AnzacPueblo_all.vcf.gz > freebayes_invariant_chr12_all.vcf.gz
