...
bcftools merge -m all -O z freebayes_invariant_chr02_combined_end.vcf.gz freebayes_invariant_chr02_AnzacPueblo_all.vcf.gz > freebayes_invariant_chr02_all.vcf.gz
