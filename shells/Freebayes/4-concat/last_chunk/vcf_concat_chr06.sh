...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_vcf_concat_chr06_al.out
#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_vcf_concat_chr06_al.err
...
freebayes_invariant_chr06_combined_end.vcf.gz freebayes_invariant_chr06_AnzacPueblo.vcf.gz > freebayes_invariant_chr06_all.vcf.gz