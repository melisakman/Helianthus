...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_freebayes3MAF.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_freebayes3MAF.err
