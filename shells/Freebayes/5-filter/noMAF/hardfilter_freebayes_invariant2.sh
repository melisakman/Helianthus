...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_freebayes2MAF.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_freebayes2MAF.err
