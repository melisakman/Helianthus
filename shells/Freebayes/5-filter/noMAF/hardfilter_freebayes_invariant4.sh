...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_freebayes4MAF.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_freebayes4MAF.err
