...
vcftools --gzvcf ../HanXRQChr01_filter01_ordered.vcf --minQ 50 --minDP 3 --maxDP 25 --keep wd_list.txt --max-missing 0.8 --window-pi 10000 --out /clusterfs/vector/scratch/makman/new_variant_calling/pi/wd_pi_chr01_10kb
...
vcftools --gzvcf ../HanXRQChr01_filter01_ordered.vcf --minQ 50 --minDP 3 --maxDP 25 --keep lr_list.txt --max-missing 0.8 --window-pi 10000 --out /clusterfs/vector/scratch/makman/new_variant_calling/pi/lr_pi_chr01_10kb
