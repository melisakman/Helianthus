...
#SBATCH --time=4:00:00
#SBATCH -o /global/home/users/makman/vcftools/outs/vcftools_new_VC_tajD15_update.out
#SBATCH -e /global/home/users/makman/vcftools/outs/vcftools_new_VC_tajD15_update.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
#SBATCH --array=1-17
module load vcftools/0.1.13
# vcftools --gzvcf HanXRQChr01_filter01.vcf --minQ 50 --minDP 3 --maxDP 25 --keep wd_list.txt --max-missing 0.8 --TajimaD 10000  --out /clusterfs/vector/scratch/makman/new_variant_calling/TajD/wd_TajD_chr01_10kb
...
vcftools --gzvcf HanXRQChr01_filter01.vcf --minQ 50 --minDP 3 --maxDP 25 --keep lr_list.txt --max-missing 0.8 --TajimaD 10000  --out /clusterfs/vector/scratch/makman/new_variant_calling/TajD/lr_TajD_chr01_10kb
