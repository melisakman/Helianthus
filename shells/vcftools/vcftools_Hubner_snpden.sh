...
vcftools --gzvcf ./XRQ_fil_ordered_combined.vcf.gz --chr HanXRQChr02 --minQ 50 --minDP 3 --maxDP 25 --keep lr_list.txt --max-missing 0.8 --SNPdensity 2000 --out lr_snpden_chr02_250bp
