...
vcftools --gzvcf ./XRQ_fil_ordered_combined.vcf.gz --chr HanXRQChr02 --minQ 50 --minDP 3 --maxDP 25 --keep wd_list.txt --max-missing 0.8 --SNPdensity 2000 --out wd_snpden_chr02_2kb
