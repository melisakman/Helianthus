...
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr02 --recode --stdout > merged_NVC_filtered_dups_removed_chr02.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr03 --recode --stdout > merged_NVC_filtered_dups_removed_chr03.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr04 --recode --stdout > merged_NVC_filtered_dups_removed_chr04.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr05 --recode --stdout > merged_NVC_filtered_dups_removed_chr05.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr06 --recode --stdout > merged_NVC_filtered_dups_removed_chr06.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr07 --recode --stdout > merged_NVC_filtered_dups_removed_chr07.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr08 --recode --stdout > merged_NVC_filtered_dups_removed_chr08.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr09 --recode --stdout > merged_NVC_filtered_dups_removed_chr09.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr10 --recode --stdout > merged_NVC_filtered_dups_removed_chr10.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr11 --recode --stdout > merged_NVC_filtered_dups_removed_chr11.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr12 --recode --stdout > merged_NVC_filtered_dups_removed_chr12.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr13 --recode --stdout > merged_NVC_filtered_dups_removed_chr13.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr14 --recode --stdout > merged_NVC_filtered_dups_removed_chr14.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr15 --recode --stdout > merged_NVC_filtered_dups_removed_chr15.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr16 --recode --stdout > merged_NVC_filtered_dups_removed_chr16.vcf
vcftools --vcf merged_NVC_filtered_dups_removed.vcf --chr HanXRQChr17 --recode --stdout > merged_NVC_filtered_dups_removed_chr17.vcf
