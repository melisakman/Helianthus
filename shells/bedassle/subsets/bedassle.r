...
MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.001, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_8",
  continue = FALSE, continuing.params = FALSE)
...
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.001, aE_stp = 0.01, a2_stp = 0.001, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_10",
#  continue = FALSE, continuing.params = NULL)

#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.1, aE_stp = 0.01, a2_stp = 0.001, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_11",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.001, a2_stp = 0.001, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_12",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.1, a2_stp = 0.001, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_13",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.0001, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_14",
#  continue = FALSE, continuing.params = NULL)

#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.01, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_15",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.001, phi_stp = 0.0001, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_16",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.001, phi_stp = 0.01, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_17",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.001, thetas_stp = 0.001, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_18",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.001, thetas_stp = 0.1, mu_stp = 1.5, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_19",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.001, thetas_stp = 0.01, mu_stp = 0.15, ngen = 1e7, 
#  printfreq=10000, savefreq=1e5, samplefreq=10000, prefix = "all_final_v22_20",
#  continue = FALSE, continuing.params = NULL)
#
#MCMC(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.00005,
#  aD_stp = 0.01, aE_stp = 0.01, a2_stp = 0.001, thetas_stp = 0.01, mu_stp = 10.5, ngen = 1e7, 
