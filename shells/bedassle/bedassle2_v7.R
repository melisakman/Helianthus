...
#MCMC_BB(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.0001,
#     aD_stp = 0.1, aE_stp = 0.1, a2_stp = 0.01, phi_stp = 0.01, thetas_stp = 0.01, mu_stp = 0.01, ngen = 1000, 
#     printfreq=1000, savefreq=1000, samplefreq=5, prefix = "subset2_v7_3_",
#     continue = FALSE, continuing.params = NULL)
#MCMC_BB(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.0001,
#     aD_stp = 0.1, aE_stp = 0.1, a2_stp = 0.01, phi_stp = 0.01, thetas_stp = 0.01, mu_stp = 0.9, ngen = 1000, 
#     printfreq=1000, savefreq=1000, samplefreq=5, prefix = "subset2_v7_4_",
#     continue = FALSE, continuing.params = NULL)
MCMC_BB(counts=count, sample_sizes = sample, D=Euc_dist, E=Climate, k=nrow(count), loci=ncol(count), delta = 0.0001,
     aD_stp = 0.1, aE_stp = 0.1, a2_stp = 0.01, phi_stp = 0.01, thetas_stp = 0.01, mu_stp = 1.5, ngen = 1000, 
     printfreq=1000, savefreq=1000, samplefreq=5, prefix = "subset2_v7_5_",
     continue = FALSE, continuing.params = NULL)
