...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr2_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr2_ethno.err
...
-V combined_chr02_ethno.g.vcf.gz \
-O VC_MA_chr02_ethno.vcf.gz