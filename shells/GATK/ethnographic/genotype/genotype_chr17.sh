...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr17_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr17_ethno.err
...
-V combined_chr17_ethno.g.vcf.gz \
-O VC_MA_chr17_ethno.vcf.gz