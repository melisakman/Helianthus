...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr9_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr9_ethno.err
...
-V combined_chr09_ethno.g.vcf.gz \
-O VC_MA_chr09_ethno.vcf.gz