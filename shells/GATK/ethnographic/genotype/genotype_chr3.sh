...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr3_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr3_ethno.err
...
-V combined_chr03_ethno.g.vcf.gz \
-O VC_MA_chr03_ethno.vcf.gz