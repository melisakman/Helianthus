...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr4_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr4_ethno.err
...
-V combined_chr04_ethno.g.vcf.gz \
-O VC_MA_chr04_ethno.vcf.gz