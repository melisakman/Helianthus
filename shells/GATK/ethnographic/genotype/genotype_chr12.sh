...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr12_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr12_ethno.err
...
-V combined_chr12_ethno.g.vcf.gz \
-O VC_MA_chr12_ethno.vcf.gz