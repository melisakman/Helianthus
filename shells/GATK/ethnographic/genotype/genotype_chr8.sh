...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr8_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr8_ethno.err
...
-V combined_chr08_ethno.g.vcf.gz \
-O VC_MA_chr08_ethno.vcf.gz