...
# java -jar /clusterfs/rosalind/users/makman/Trimmomatic-0.36/trimmomatic-0.36.jar PE Ari_Mand/Ari_Mand_USPD16084925-AK1650_HJHWVCCXY_L4_1.fq.gz Ari_Mand/Ari_Mand_USPD16084925-AK1650_HJHWVCCXY_L4_2.fq.gz Ari_Mand_R1_trimmed.fastq.gz Ari_Mand_R1_unpaired.fastq.gz Ari_Mand_R2_trimmed.fastq.gz Ari_Mand_R2_unpaired.fastq.gz ILLUMINACLIP:adaptersRay.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36
