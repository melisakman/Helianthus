...
# java -jar /clusterfs/rosalind/users/makman/Trimmomatic-0.36/trimmomatic-0.36.jar PE Se_purp/Se_purp_USPD16084925-AK974_HJHWVCCXY_L4_1.fq.gz Se_purp/Se_purp_USPD16084925-AK974_HJHWVCCXY_L4_2.fq.gz Se_purp_R1_trimmed.fastq.gz Se_purp_R1_unpaired.fastq.gz Se_purp_R2_trimmed.fastq.gz Se_purp_R2_unpaired.fastq.gz ILLUMINACLIP:adaptersRay.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36
