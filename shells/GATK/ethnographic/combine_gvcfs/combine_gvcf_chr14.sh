...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr14_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr14_ethno.err
...
-O combined_chr14_ethno.g.vcf.gz
