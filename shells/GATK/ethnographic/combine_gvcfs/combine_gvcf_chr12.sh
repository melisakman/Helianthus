...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr12_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr12_ethno.err
...
-O combined_chr12_ethno.g.vcf.gz
