...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr02_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr02_ethno.err
...
--variant Hopi_real_chr02.g.vcf.gz \
...
-O combined_chr02_ethno.g.vcf.gz
