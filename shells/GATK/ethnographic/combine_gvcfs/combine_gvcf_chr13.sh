...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr13_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr13_ethno.err
...
-O combined_chr13_ethno.g.vcf.gz
