...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr11_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr11_ethno.err
...
-O combined_chr11_ethno.g.vcf.gz
