...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr07_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr07_ethno.err
...
-O combined_chr07_ethno.g.vcf.gz
