#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/fastq/ready/trimmedd/
#SBATCH -J gzip7
...
#SBATCH -o /global/home/users/makman/GATK/outs/gzip7.out
#SBATCH -e /global/home/users/makman/GATK/outs/gzip7.err
