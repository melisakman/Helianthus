...
#SBATCH -o /global/home/users/makman/GATK/outs/fix_fastq11.out
#SBATCH -e /global/home/users/makman/GATK/outs/fix_fastq11.err
...
# gunzip RHA426_R1_trimmed.fastq.gz
# gunzip RHA426_R2_trimmed.fastq.gz
