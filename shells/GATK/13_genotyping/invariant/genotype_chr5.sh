...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr5_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr5_invariant.err
...
-L HanXRQChr05 --includeNonVariantSites \
...
--variant Hopi_real_chr05.g.vcf.gz \
...
-o ../../invariants/VCMA_chr05.vcf.gz