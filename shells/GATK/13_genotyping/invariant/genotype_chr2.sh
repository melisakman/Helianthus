...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr2_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr2_invariant.err
...
-L HanXRQChr02 --includeNonVariantSites \
...
-o ../../invariants/VCMA_chr02.vcf.gz