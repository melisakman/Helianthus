...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr3_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr3_invariant.err
...
-L HanXRQChr03 --includeNonVariantSites \
...
-o ../../invariants/VCMA_chr03.vcf.gz