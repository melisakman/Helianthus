...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr9_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr9_invariant.err
...
-L HanXRQChr09 --includeNonVariantSites \
...
--variant Hopi_real_chr09.g.vcf.gz \
...
-o ../../invariants/VCMA_chr09.vcf.gz