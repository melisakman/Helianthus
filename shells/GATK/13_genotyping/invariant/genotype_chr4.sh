...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr4_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr4_invariant.err
...
-L HanXRQChr04 --includeNonVariantSites \
...
-o ../../invariants/VCMA_chr04.vcf.gz