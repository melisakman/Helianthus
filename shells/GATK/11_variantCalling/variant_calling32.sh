...
#SBATCH -o /global/home/users/makman/GATK/outs/variant_cal32_re.out
#SBATCH -e /global/home/users/makman/GATK/outs/variant_cal32_re.err
...
# 
/clusterfs/rosalind/users/makman/gatk-4.0.0.0/gatk --java-options "-Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files/ -Xmx64G" HaplotypeCaller -R /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -I annSD1W-35_sorted_markdup_recal.bam -O annSD1W-35_re.g.vcf.gz -ERC GVCF
