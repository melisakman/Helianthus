...
# 
/clusterfs/rosalind/users/makman/gatk-4.0.0.0/gatk --java-options "-Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files/ -Xmx64G" HaplotypeCaller -nct 20 -R /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -I PPN255_Manchurian_sorted_markdup_recal.bam -O PPN255_Manchurian.g.vcf.gz -ERC GVCF
