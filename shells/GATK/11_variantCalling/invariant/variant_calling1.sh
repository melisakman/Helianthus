...
java -Xmx<64G> -Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp -jar /clusterfs/vector/home/groups/software/sl-7.x86_64/modules/gatk/3.8.0/GenomeAnalysisTK.jar -T HaplotypeCaller --emitRefConfidence GVCF --variant_index_type LINEAR --variant_index_parameter 128000 -R /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -I Anzac_Pueblo_sorted_markdup_recal_RG.bam -O ../fastq/invariants/Anzac_Pueblo_invariant.g.vcf.gz 
