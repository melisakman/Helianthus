...
#SBATCH -o /global/home/users/makman/GATK/outs/hardfilter_VCMA_SNP_chr03_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/hardfilter_VCMA_SNP_chr03_invariant.err
...
java -Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files2/ -Xmx60G -jar /clusterfs/rosalind/users/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar -T SelectVariants \
	-R /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa \
	-V VCMA_chr03_SNP_filterInfo.vcf.gz \
	--excludeFiltered \
	-o VCMA_chr03_SNP_hardfiltered.vcf.gz 
