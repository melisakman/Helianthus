...
zcat VCMA_GATK_chr14_unsorted.vcf.gz | vcf-sort -t /clusterfs/rosalind/users/makman/temp VCMA_GATK_chr14_unsorted.vcf.gz > filtered_combined/VCMA_GATK_chr14_sorted.vcf.gz
