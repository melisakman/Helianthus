...
#SBATCH --time=9:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/fastqc_trim18.out
#SBATCH -e /global/home/users/makman/GATK/outs/fastqc_trim18.err
...
fastqc SF33_R1_trimmed_fastq.gz
fastqc SF33_R2_trimmed_fastq.gz
fastqc Seneca_R1_trimmed_fastq.gz
fastqc Seneca_R2_trimmed_fastq.gz
