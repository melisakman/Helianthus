...
#SBATCH --mem=36000
#SBATCH --time=9:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/fastqc_trim2.out
#SBATCH -e /global/home/users/makman/GATK/outs/fastqc_trim2.err
...
fastqc HA124_R1_trimmed_fastq.gz
fastqc HA124_R2_trimmed_fastq.gz
fastqc HA316_R1_trimmed_fastq.gz
fastqc HA316_R2_trimmed_fastq.gz
