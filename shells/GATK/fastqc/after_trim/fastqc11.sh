...
#SBATCH --time=9:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/fastqc_trim11.out
#SBATCH -e /global/home/users/makman/GATK/outs/fastqc_trim11.err
...
fastqc MexCult7_R1_trimmed_fastq.gz
fastqc MexCult7_R2_trimmed_fastq.gz
fastqc MexCult9_R1_trimmed_fastq.gz
fastqc MexCult9_R2_trimmed_fastq.gz
