...
#SBATCH --time=9:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/fastqc_trim10.out
#SBATCH -e /global/home/users/makman/GATK/outs/fastqc_trim10.err
...
fastqc MexCult3_R1_trimmed_fastq.gz
fastqc MexCult3_R2_trimmed_fastq.gz
fastqc MexCult6_R1_trimmed_fastq.gz
fastqc MexCult6_R2_trimmed_fastq.gz
