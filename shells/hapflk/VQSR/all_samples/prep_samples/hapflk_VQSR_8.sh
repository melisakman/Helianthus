...
python ../plink_ped_fixer.py ../samples_VQSR.txt chr08_final_plink.ped chr08_final_plink_fixed.ped

cp chr08_final_plink.map chr08_final_plink_fixed.map

# module load hapflk/1.4
# 
# hapflk --file chr08_final_plink_fixed --miss_pheno 0 --chr 01 --from 1 --to 20000000 -p chr08_1 --ncpu 12 -K 15
