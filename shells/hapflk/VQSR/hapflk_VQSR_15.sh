...
python ../plink_ped_fixer.py ../samples_VQSR.txt chr15_final_plink.ped chr15_final_plink_fixed.ped

cp chr15_final_plink.map chr15_final_plink_fixed.map

# module load hapflk/1.4
# 
# hapflk --file chr15_final_plink_fixed --miss_pheno 0 --chr 01 --from 1 --to 20000000 -p chr15_1 --ncpu 12 -K 15
