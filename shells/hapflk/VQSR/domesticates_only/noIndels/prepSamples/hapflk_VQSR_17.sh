...
vcftools --vcf chr17_final_lessStringentInvariants_onlyvariants_noHanXRQ.vcf --remove-indels --out chr17_final_plink_noIndels --plink

python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr17_final_plink_noIndels.ped chr17_final_plink_noIndels_domesticates_ethno.ped

cp chr17_final_plink_noIndels.map chr17_final_plink_noIndels_domesticates_ethno.map

# module load hapflk/1.4
# 
# hapflk --file chr17_final_plink_noIndels_domesticates_ethno --miss_pheno 0 --chr 01 --from 1 --to 20000000 -p chr17_1 --ncpu 12 -K 15
