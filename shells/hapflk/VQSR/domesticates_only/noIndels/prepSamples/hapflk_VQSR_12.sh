...
vcftools --vcf chr12_final_lessStringentInvariants_onlyvariants_noHanXRQ.vcf --remove-indels --out chr12_final_plink_noIndels --plink

python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr12_final_plink_noIndels.ped chr12_final_plink_noIndels_domesticates_ethno.ped

cp chr12_final_plink_noIndels.map chr12_final_plink_noIndels_domesticates_ethno.map

# module load hapflk/1.4
# 
# hapflk --file chr12_final_plink_noIndels_domesticates_ethno --miss_pheno 0 --chr 01 --from 1 --to 20000000 -p chr12_1 --ncpu 12 -K 15
