...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates.txt chr01_final_plink.ped chr01_final_plink_domesticates.ped

cp chr01_final_plink.map chr01_final_plink_domesticates.map

# module load hapflk/1.4
# 
# hapflk --file chr01_final_plink_domesticates --miss_pheno 0 --chr 01 --from 1 --to 20000000 -p chr01_1 --ncpu 12 -K 15
