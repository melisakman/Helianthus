...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates.txt chr06_final_plink.ped chr06_final_plink_domesticates.ped

cp chr06_final_plink.map chr06_final_plink_domesticates.map

# module load hapflk/1.4
# 
# hapflk --file chr06_final_plink_domesticates --miss_pheno 0 --chr 01 --from 1 --to 20000000 -p chr06_1 --ncpu 12 -K 15
