...
python ../plink_ped_fixer.py ../samples_VQSR_lrOnly.txt chr17_final_plink.ped chr17_final_plink_lrOnly.ped

cp chr17_final_plink.map chr17_final_plink_lrOnly.map
# 
