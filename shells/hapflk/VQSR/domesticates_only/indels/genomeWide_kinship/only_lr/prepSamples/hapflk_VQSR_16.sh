...
python ../plink_ped_fixer.py ../samples_VQSR_lrOnly.txt chr16_final_plink.ped chr16_final_plink_lrOnly.ped

cp chr16_final_plink.map chr16_final_plink_lrOnly.map
