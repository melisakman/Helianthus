...
python ../plink_ped_fixer.py ../samples_VQSR_lrOnly.txt chr06_final_plink.ped chr06_final_plink_lrOnly.ped

cp chr06_final_plink.map chr06_final_plink_lrOnly.map
