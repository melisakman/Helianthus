...
python ../plink_ped_fixer.py ../samples_VQSR_lrOnly.txt chr12_final_plink.ped chr12_final_plink_lrOnly.ped

cp chr12_final_plink.map chr12_final_plink_lrOnly.map
