...
python ../plink_ped_fixer.py ../samples_VQSR_lrOnly.txt chr08_final_plink.ped chr08_final_plink_lrOnly.ped

cp chr08_final_plink.map chr08_final_plink_lrOnly.map
