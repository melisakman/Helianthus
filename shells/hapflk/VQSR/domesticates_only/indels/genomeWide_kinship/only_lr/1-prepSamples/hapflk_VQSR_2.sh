...
python ../plink_ped_fixer.py ../samples_VQSR_lrOnly.txt chr02_final_plink.ped chr02_final_plink_lrOnly.ped

cp chr02_final_plink.map chr02_final_plink_lrOnly.map
