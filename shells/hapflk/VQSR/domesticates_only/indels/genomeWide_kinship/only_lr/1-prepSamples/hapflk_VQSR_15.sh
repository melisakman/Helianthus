...
python ../plink_ped_fixer.py ../samples_VQSR_lrOnly.txt chr15_final_plink.ped chr15_final_plink_lrOnly.ped

cp chr15_final_plink.map chr15_final_plink_lrOnly.map
