...
python ../plink_ped_fixer.py ../samples_VQSR_lrOnly.txt chr04_final_plink.ped chr04_final_plink_lrOnly.ped

cp chr04_final_plink.map chr04_final_plink_lrOnly.map
