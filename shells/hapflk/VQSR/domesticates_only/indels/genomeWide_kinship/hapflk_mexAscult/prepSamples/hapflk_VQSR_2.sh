...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr02_final_plink.ped chr02_final_plink_domesticates_ethno_mexAscult.ped

cp chr02_final_plink.map chr02_final_plink_domesticates_ethno_mexAscult.map
