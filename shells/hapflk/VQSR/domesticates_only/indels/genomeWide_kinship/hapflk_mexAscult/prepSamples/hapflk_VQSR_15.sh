...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr15_final_plink.ped chr15_final_plink_domesticates_ethno_mexAscult.ped

cp chr15_final_plink.map chr15_final_plink_domesticates_ethno_mexAscult.map
