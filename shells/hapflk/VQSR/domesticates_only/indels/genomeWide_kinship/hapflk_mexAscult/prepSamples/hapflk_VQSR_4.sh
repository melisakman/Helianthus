...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr04_final_plink.ped chr04_final_plink_domesticates_ethno_mexAscult.ped

cp chr04_final_plink.map chr04_final_plink_domesticates_ethno_mexAscult.map
