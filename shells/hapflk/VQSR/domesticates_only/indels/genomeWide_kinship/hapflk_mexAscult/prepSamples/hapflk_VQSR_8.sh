...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr08_final_plink.ped chr08_final_plink_domesticates_ethno_mexAscult.ped

cp chr08_final_plink.map chr08_final_plink_domesticates_ethno_mexAscult.map
