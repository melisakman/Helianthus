...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr14_final_plink.ped chr14_final_plink_domesticates_ethno_mexAscult.ped

cp chr14_final_plink.map chr14_final_plink_domesticates_ethno_mexAscult.map
