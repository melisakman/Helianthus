...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr12_final_plink.ped chr12_final_plink_domesticates_ethno_mexAscult.ped

cp chr12_final_plink.map chr12_final_plink_domesticates_ethno_mexAscult.map
