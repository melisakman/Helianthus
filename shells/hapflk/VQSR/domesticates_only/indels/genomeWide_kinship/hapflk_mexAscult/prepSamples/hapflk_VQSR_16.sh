...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr16_final_plink.ped chr16_final_plink_domesticates_ethno_mexAscult.ped

cp chr16_final_plink.map chr16_final_plink_domesticates_ethno_mexAscult.map
