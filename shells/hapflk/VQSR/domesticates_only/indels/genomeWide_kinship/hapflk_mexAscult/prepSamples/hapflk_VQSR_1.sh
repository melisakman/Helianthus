...
python ../plink_ped_fixer.py ../samples_VQSR_domesticates_ethno.txt chr01_final_plink.ped chr01_final_plink_domesticates_ethno_mexAscult.ped

cp chr01_final_plink.map chr01_final_plink_domesticates_ethno_mexAscult.map
