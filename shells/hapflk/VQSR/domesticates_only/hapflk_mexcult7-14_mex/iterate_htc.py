...
hapflk --file chr""" + str(chr) + "_final_plink_domesticates_ethno --outgroup=Wild --kinship kinship/chr" + str(chr) + "_tree_kinship_fij.txt --miss_pheno 0 --chr " + str(chr) + " --from " + str(start) + " --to " + str(end) + " -p hapflk_domesticates/chr" + str(chr) + "_" + str(i) + " --ncpu 12 -K 15")
	start += 20000000
	end += 20000000
