...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage15.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage15.err
...
-L HanXRQChr15 -o ../../coverage_haplotype/coverage_chr15 -I ./bams.list