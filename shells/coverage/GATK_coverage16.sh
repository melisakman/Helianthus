...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage16.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage16.err
...
-L HanXRQChr16 -o ../../coverage_haplotype/coverage_chr16 -I ./bams.list