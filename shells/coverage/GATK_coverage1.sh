...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage1.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage1.err
...
-L HanXRQChr01 -o ../../coverage_haplotype/coverage_chr01 -I ./bams.list