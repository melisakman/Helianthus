...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage11.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage11.err
...
-L HanXRQChr11 -o ../../coverage_haplotype/coverage_chr11 -I ./bams.list