...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage7.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage7.err
...
-L HanXRQChr07 -o ../../coverage_haplotype/coverage_chr07 -I ./bams.list