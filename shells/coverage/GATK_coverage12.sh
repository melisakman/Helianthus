...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage12.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage12.err
...
-L HanXRQChr12 -o ../../coverage_haplotype/coverage_chr12 -I ./bams.list