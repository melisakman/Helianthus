...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage2.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage2.err
...
-L HanXRQChr02 -o ../../coverage_haplotype/coverage_chr02 -I ./bams.list