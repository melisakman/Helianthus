...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage10.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage10.err
...
-L HanXRQChr10 -o ../../coverage_haplotype/coverage_chr10 -I ./bams.list