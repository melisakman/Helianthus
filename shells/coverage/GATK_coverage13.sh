...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage13.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage13.err
...
-L HanXRQChr13 -o ../../coverage_haplotype/coverage_chr13 -I ./bams.list