...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage6.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage6.err
...
-L HanXRQChr06 -o ../../coverage_haplotype/coverage_chr06 -I ./bams.list