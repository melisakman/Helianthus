...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage4.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage4.err
...
-L HanXRQChr04 -o ../../coverage_haplotype/coverage_chr04 -I ./bams.list