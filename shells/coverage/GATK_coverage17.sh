...
#SBATCH -o /global/home/users/makman/GATK/outs/coverage17.out
#SBATCH -e /global/home/users/makman/GATK/outs/coverage17.err
...
-L HanXRQChr17 -o ../../coverage_haplotype/coverage_chr17 -I ./bams.list