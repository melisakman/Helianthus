...
zcat freebayes/freebayes_invariant_chr03_combined.vcf.gz | bcftools filter -g 5 -i 'TYPE = "ref"' | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > freebayes/freebayes_invariant_chr03_combined_ref.vcf.gz
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix freebayes/freebayes_invariant_chr03_combined_ref.vcf.gz
...
bcftools isec -n +2 -O z -p ../bcftools_isec/chr03_2_ref_unfiltered gvcfs/genotyping/chr03_GATK_NoVar.vcf.gz \
freebayes/freebayes_invariant_chr03_combined_ref.vcf.gz \
