...
zcat freebayes/no_mnp/freebayes_invariant_chr17_.vcf.gz | bcftools filter -g 5 -i 'TYPE = "ref"' | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > freebayes/no_mnp/freebayes_invariant_chr17_ref.vcf.gz
