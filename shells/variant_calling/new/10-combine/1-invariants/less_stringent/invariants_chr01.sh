...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix freebayes/freebayes_invariant_chr01_combined_ref.vcf.gz
...
freebayes/freebayes_invariant_chr01_combined_ref.vcf.gz \
