...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_all_chr16.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_all_chr16.err
...
chr16_2_ref/chr16_2plus_ref_hardfiltered.vcf.gz | bcftools sort -T /global/scratch/makman/temp \
