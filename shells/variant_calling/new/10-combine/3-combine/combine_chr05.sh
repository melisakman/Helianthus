...
../sams/gvcfs/genotyping/ chr05_GATK_indel_annot_hardfiltered_secondFilter.vcf.gz \
 chr05_2_ref/ chr05_2plus_ref_hardfiltered_secondfilter.vcf.gz | /clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-sort -t /clusterfs/rosalind/users/makman/temp \
