...
../sams/gvcfs/genotyping/ chr02_GATK_indel_annot_hardfiltered_secondFilter.vcf.gz \
 chr02_2_ref/ chr02_2plus_ref_hardfiltered_secondfilter.vcf.gz | /clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-sort -t /clusterfs/rosalind/users/makman/temp \
