...
#SBATCH -o /global/home/users/makman/GATK/outs/hardfilter_VCMA_indel_chr17_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/hardfilter_VCMA_indel_chr17_invariant.err
...
#    -R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
#    -V chr17_GATK_indel.vcf.gz \
#    -O chr17_GATK_indel_annot.vcf.gz \
...
# -R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
# -V chr17_GATK_indel_annot.vcf.gz \
# --filterExpression "QD < 2.0 || FS > 200.0 || SOR > 10.0 || ReadPosRankSum < -20.0" \
# --filterName "my_indel_filter" \
# -o chr17_GATK_indel_annot_filterInfo.vcf.gz  
# 	
# java -Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files2/ -Xmx60G -jar /clusterfs/rosalind/users/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar -T SelectVariants \
# -R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
# -V chr17_GATK_indel_annot_filterInfo.vcf.gz \
# --excludeFiltered \
# -o chr17_GATK_indel_annot_hardfiltered.vcf.gz

zcat chr17_GATK_indel_annot_hardfiltered.vcf.gz | vcftools --vcf - --minDP 1 --max-missing 0.8 --maxDP 30 --recode --stdout | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > chr17_GATK_indel_annot_hardfiltered_secondFilter.vcf.gz
