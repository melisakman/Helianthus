...
#SBATCH -o /global/scratch/makman/GATK/sams//global/home/users/makman/GATK/outs/map37.out
...
/clusterfs/rosalind/users/makman/NextGenMap-0.5.2/bin/ngm-0.5.2/ngm -r /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta --skip-mate-check -p -1 ../fastq/raw/ready/ann05-ccNM_trimmed_R1.fastq.gz -2 ../fastq/raw/ready/ann05-ccNM_trimmed_R2.fastq.gz -o /global/scratch/makman/GATK/sams/ann05-ccNM.sam
/clusterfs/rosalind/users/makman/NextGenMap-0.5.2/bin/ngm-0.5.2/ngm -r /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta --skip-mate-check -p -1 ../fastq/raw/ready/ann10-ccIL_trimmed_R1.fastq.gz -2 ../fastq/raw/ready/ann10-ccIL_trimmed_R2.fastq.gz -o /global/scratch/makman/GATK/sams/ann10-ccIL.sam
...
# /clusterfs/rosalind/users/makman/NextGenMap-0.5.2/bin/ngm-0.5.2/ngm -r /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta -p -1 ../fastq/raw/ready/ann29-neSD_trimmed_R1.fastq.gz -2 ../fastq/raw/ready/ann29-neSD_trimmed_R2.fastq.gz -o /global/scratch/makman/GATK/sams/ann29-neSD.sam
# /clusterfs/rosalind/users/makman/NextGenMap-0.5.2/bin/ngm-0.5.2/ngm -r /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta -p -1 ../fastq/raw/ready/ann44-ccCA_trimmed_R1.fastq.gz -2 ../fastq/raw/ready/ann44-ccCA_trimmed_R2.fastq.gz -o /global/scratch/makman/GATK/sams/ann44-ccCA.sam
