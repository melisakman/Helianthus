...
/clusterfs/rosalind/users/makman/NextGenMap-0.5.2/bin/ngm-0.5.2/ngm -r /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta --skip-mate-check -p -1 ../fastq/raw/ready/ann20-seAZ_trimmed_R1.fastq.gz -2 ../fastq/raw/ready/ann20-seAZ_trimmed_R2.fastq.gz -o ann20-seAZ.sam
# /clusterfs/rosalind/users/makman/NextGenMap-0.5.2/bin/ngm-0.5.2/ngm -r /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta --skip-mate-check -p -1 ../fastq/raw/ready/ann28-swSK_trimmed_R1.fastq.gz -2 ../fastq/raw/ready/ann28-swSK_trimmed_R2.fastq.gz -o ann28-swSK.sam
