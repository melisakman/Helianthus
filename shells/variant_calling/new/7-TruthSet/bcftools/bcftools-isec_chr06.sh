...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix freebayes/freebayes_variants_chr06_filtered.vcf.gz
...
freebayes/freebayes_variants_chr06_filtered.vcf.gz \
