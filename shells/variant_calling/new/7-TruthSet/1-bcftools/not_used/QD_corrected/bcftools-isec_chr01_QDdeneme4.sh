...
/global/scratch/makman/gatk-4.1.0.0/gatk --java-options "-Xmx64g -Djava.io.tmpdir=/global/scratch/makman/temp_files/" VariantAnnotator \
   ...
   -V gvcfs/genotyping/chr04_GATK_SNP.vcf.gz \
   -O gvcfs/genotyping/chr04_GATK_SNP_annot.vcf.gz \
...
-R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
-V gvcfs/genotyping/chr04_GATK_SNP_annot.vcf.gz \
--filter-expression "QD < 2.0 || MQ < 40.0 || FS > 60.0 || SOR > 3.0 || MQRankSum < -12.5 || ReadPosRankSum < -8.0" \
--filter-name "my_SNP_filter" \
-O chr04_GATK_SNP_annot_filterInfo.vcf.gz
...
-R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
-V chr04_GATK_SNP_annot_filterInfo.vcf.gz \
--exclude-filtered \
-O chr04_GATK_SNP_annot_filterInfo_hardfiltered.vcf.gz



bcftools isec -n =3 -O z -p ../bcftools_isec/chr04_3_QD chr04_GATK_SNP_annot_filterInfo_hardfiltered.vcf.gz \
