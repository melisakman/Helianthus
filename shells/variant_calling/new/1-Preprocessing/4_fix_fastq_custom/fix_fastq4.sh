...
#SBATCH -o /global/home/users/makman/GATK/outs/fix_fastq4.out
#SBATCH -e /global/home/users/makman/GATK/outs/fix_fastq4.err
...
# python remove_pair_info.py PPN255_Manchurian_R1_trimmed_fastq PPN255_Manchurian_R1_trimmed_fixed.fastq
# python remove_pair_info.py PPN255_Manchurian_R2_trimmed_fastq PPN255_Manchurian_R2_trimmed_fixed.fastq
