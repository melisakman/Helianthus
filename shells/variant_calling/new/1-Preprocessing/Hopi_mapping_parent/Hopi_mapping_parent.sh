...
cp SRR5140381_1.fastq.gz ready/Hopi_mapping_parent_R1.fastq.gz
cp SRR5140381_2.fastq.gz ready/Hopi_mapping_parent_R2.fastq.gz
...
/clusterfs/rosalind/users/makman/NextGenMap-0.5.2/bin/ngm-0.5.2/ngm -r /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta -p -1 ready/Hopi_mapping_parent_R1_trimmed.fastq.gz -2 ready/Hopi_mapping_parent_R2_trimmed.fastq.gz -o ../../sams/Hopi_mapping_parent_real.sam
