...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_invariant_chr17_chunk10.out
#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_invariant_chr17_chunk10.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
module load freebayes/v1.1.0-56-ga180635
TMPDIR=/clusterfs/rosalind/users/makman/temp

freebayes -f /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta --report-monomorphic --haplotype-length -1 -r HanXRQChr17:36000001-40000000 \
...
ann1238_lane2_62_5M_markdup_readGroup.bam > ../freebayes/no_mnp/freebayes_invariant_chr17_chunk10.vcf