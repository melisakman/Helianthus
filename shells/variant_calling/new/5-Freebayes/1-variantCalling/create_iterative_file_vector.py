...
freebayes -f /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta --report-monomorphic -r HanXRQChr""" + str(chr) + ":" + str(border_l) + "-" + str(border_r) + " \\" +
