...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_freebayes_chr12.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_freebayes_chr12.err
...
zcat freebayes_invariant_chr12_combined.vcf.gz | bcftools filter -g 5 -i 'TYPE = "snp" && QUAL > 20 && MQM > 40 || TYPE = "indel" && QUAL > 20 || TYPE = "mnp" && QUAL > 20 && MQM > 40 || TYPE = "ref" && QUAL < 2.723e-15 && MQMR > 40' | vcftools --vcf - --minDP 3 --max-missing 0.8 --maxDP 25 --recode --stdout | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > freebayes_variants_chr12_filtered.vcf.gz
