...
#SBATCH -o /global/home/users/makman/vcftools/outs/vcftools_MA_fst2.out
#SBATCH -e /global/home/users/makman/vcftools/outs/vcftools_MA_fst2.err
...
# vcftools --gzvcf chr04_final.vcf.gz --weir-fst-pop wd_list.txt --weir-fst-pop lr_list_noHopi.txt --fst-window-size 10000 --out fst/lr_wd_chr04_10kb_noHopi
