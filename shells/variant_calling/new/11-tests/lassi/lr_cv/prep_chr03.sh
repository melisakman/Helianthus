...
python /global/home/users/makman/git/Helianthus/shells/variant_calling/new/11-tests/lassi/vcf2genotype_lassi.py ../chr03_SNP.vcf ../cv_lr_list.txt chr03_SNP_cv_lr_lassi.txt  
