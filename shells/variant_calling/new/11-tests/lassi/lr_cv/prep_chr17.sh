...
python /global/home/users/makman/git/shells/Helianthus/variant_calling/new/11-tests/lassi/vcf2genotype_lassi.py ../chr17_SNP.vcf ../cv_lr_list.txt chr17_SNP_cv_lr_lassi.txt  
