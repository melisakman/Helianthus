...
python /global/home/users/makman/git/Helianthus/shells/variant_calling/new/11-tests/lassi/vcf2genotype_lassi.py ../chr13_SNP.vcf ../cv_lr_list.txt chr13_SNP_cv_lr_lassi.txt  
