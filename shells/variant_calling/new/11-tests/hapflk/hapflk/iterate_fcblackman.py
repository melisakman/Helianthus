...
hapflk --file chr""" + str(chr) + "_SNP_plink_lr_mex_ethno_fixed --miss_pheno 0 --chr " + str(chr) + " --from " + str(start) + " --to " + str(end) + " -p chr" + str(chr) + "_" + str(i) + " --ncpu 24 -K 15")
	start += 1000000
	end += 1000000
