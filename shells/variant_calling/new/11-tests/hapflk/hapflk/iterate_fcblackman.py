...
bins = int(chr_length/10000000) + 2
...
hapflk --file chr""" + str(chr) + "_SNP_plink_lr_mex_ethno_fixed --miss_pheno 0 --chr " + str(chr) + " --from " + str(start) + " --to " + str(end) + " -p chr" + str(chr) + "_" + str(i) + " --ncpu 12 -K 15")
	start += 10000000
	end += 10000000
