...
lr <- data2haplohh("chr12_SNP_lr.vcf.recode.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
wd <- data2haplohh("chr12_SNP_wd.vcf.recode.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
...
cvlr <- data2haplohh("chr12_SNP_cv_lr.vcf.recode.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
