...
lr_scan = scan_hh(lr, limhaplo = 2, phased = FALSE, polarized = FALSE, scalegap = NA, maxgap = NA,
discard_integration_at_border = TRUE, lower_ehh_y_bound = limehh,
lower_ehhs_y_bound = limehhs, threads = 20)
...
#cvlr <- data2haplohh("chr01_SNP_cv_lr.recode.vcf.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
# 
