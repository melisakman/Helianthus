...
lr <- data2haplohh("chr06_SNP_lr_heteroFiltered.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
wd <- data2haplohh("chr06_SNP_wd_heteroFiltered.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
...
write.table(analyses, file = "chr06_lr_xpehh.txt", sep = "\t")

cvlr <- data2haplohh("chr06_SNP_cv_lr_heteroFiltered.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
...
write.table(analyses, file = "chr06_cvlr_xpehh.txt", sep = "\t")
