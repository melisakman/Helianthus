...
# vcftools --vcf chr14_SNP.vcf --keep lr_list.txt --recode --out chr14_SNP_lr.vcf
# vcftools --vcf chr14_SNP.vcf --keep wd_list.txt --recode --out chr14_SNP_wd.vcf
# vcftools --vcf chr14_SNP.vcf --keep cv_lr_list.txt --recode --out chr14_SNP_cv_lr.vcf

python /global/home/users/makman/git/Helianthus/shells/variant_calling/new/11-tests/xp-ehh/xp-ehh_bug_fix/filter_hetero.py chr14_SNP_lr.vcf.recode.vcf chr14_SNP_lr_heteroFiltered.vcf
