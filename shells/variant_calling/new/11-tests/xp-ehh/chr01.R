...
lr <- data2haplohh("chr01_SNP_lr_heteroFiltered.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
wd <- data2haplohh("chr01_SNP_wd_heteroFiltered.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
...
write.table(lr_scan, file = "chr01_lr_scanhh.txt", sep = "\t")
...
write.table(wd_scan, file = "chr01_wd_scanhh.txt", sep = "\t")
...
cvlr <- data2haplohh("chr01_SNP_cv_lr_heteroFiltered.vcf", min_perc_geno.mrk = 30, polarize_vcf = FALSE)
