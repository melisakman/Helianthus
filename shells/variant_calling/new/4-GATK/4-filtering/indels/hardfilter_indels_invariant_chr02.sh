...
#SBATCH -o /global/home/users/makman/GATK/outs/hardfilter_indel_chr02.out
#SBATCH -e /global/home/users/makman/GATK/outs/hardfilter_indel_chr02.err
...
-O chr02_GATK_indel_filterInfo.vcf.gz
	
/global/scratch/makman/gatk-4.1.0.0/gatk --java-options "-Xmx64g -Djava.io.tmpdir=/global/scratch/makman/temp_files/" SelectVariants \
-R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
-V chr02_GATK_indel_filterInfo.vcf.gz \
--exclude-filtered \
-O chr02_GATK_indel_hardfiltered.vcf.gz
	
zcat chr02_GATK_indel_hardfiltered.vcf.gz | vcftools --vcf - --minDP 1 --max-missing 0.8 --maxDP 30 --recode --stdout | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > chr02_GATK_indel_secondFilter.vcf.gz
