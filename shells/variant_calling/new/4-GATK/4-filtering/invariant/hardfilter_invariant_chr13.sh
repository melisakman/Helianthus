...
#SBATCH -e /global/scratch/users/makman/GATK/outs/hardfilter_SNP_chr13.err
...
/global/scratch/makman/gatk-4.1.0.0/gatk --java-options "-Xmx64g -Djava.io.tmpdir=/global/scratch/makman/temp_files/" SelectVariants \
-R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
-V chr13_GATK_NoVar_filterInfo.vcf.gz \
--exclude-filtered \
-O chr13_GATK_NoVar_hardfiltered.vcf.gz
	

zcat chr13_GATK_NoVar_hardfiltered.vcf.gz | vcftools --vcf - --minDP 1 --max-missing 0.8 --maxDP 30 --recode --stdout | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > chr13_GATK_NoVar_hardfiltered_secondFilter.vcf.gz
