...
-O chr13_GATK_all_filterInfo.vcf.gz
...
-R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
-V chr13_GATK_all_filterInfo.vcf.gz \
--exclude-filtered \
-O chr13_GATK_all_hardfiltered.vcf.gz
	
cp chr13_GATK_all_hardfiltered.vcf.gz* /clusterfs/vector/instrumentData/blackmanlab/Helianthus/GATK_4Peter
