...
#SBATCH -e /global/home/users/makman/GATK/outs/hardfilter_SNP_chr06.err
...
cp chr06_GATK_SNP.vcf.gz /clusterfs/vector/instrumentData/blackmanlab/Helianthus/GATK_4Peter
...
--exclude-filtered \
-O chr06_GATK_SNP_hardfiltered.vcf.gz 
	
cp chr06_GATK_SNP_hardfiltered.vcf.gz /clusterfs/vector/instrumentData/blackmanlab/Helianthus/GATK_4Peter
