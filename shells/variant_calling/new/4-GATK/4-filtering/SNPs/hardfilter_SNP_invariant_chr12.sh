...
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c chr12_GATK.vcf > chr12_GATK.vcf.gz
...
-O chr12_GATK_SNP.vcf.gz 

cp chr12_GATK_SNP.vcf.gz /clusterfs/vector/instrumentData/blackmanlab/Helianthus/GATK_4Peter
...
-R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
-V chr12_GATK_SNP.vcf.gz \
--filter-expression "QD < 2.0 || MQ < 40.0 || FS > 60.0 || SOR > 3.0 || MQRankSum < -12.5 || ReadPosRankSum < -8.0" \
--filter-name "my_SNP_filter" \
-O chr12_GATK_SNP_filterInfo.vcf.gz  
	
/global/scratch/makman/gatk-4.1.0.0/gatk --java-options "-Xmx64g -Djava.io.tmpdir=/global/scratch/makman/temp_files/" SelectVariants \	
-R /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
-V chr12_GATK_SNP_filterInfo.vcf.gz \
--exclude-filtered \
-O chr12_GATK_SNP_hardfiltered.vcf.gz 
	
cp chr12_GATK_SNP_hardfiltered.vcf.gz /clusterfs/vector/instrumentData/blackmanlab/Helianthus/GATK_4Peter
