...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr04.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr04.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr04 \
-O chr04_GATK.vcf \
-L HanXRQChr04 \
