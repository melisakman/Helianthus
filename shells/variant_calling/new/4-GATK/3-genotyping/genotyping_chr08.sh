...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr08.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr08.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr08 \
-O chr08_GATK.vcf \
-L HanXRQChr08 \
