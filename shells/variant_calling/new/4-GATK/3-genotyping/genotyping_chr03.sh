...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr03.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr03.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr03 \
-O chr03_GATK.vcf \
-L HanXRQChr03 \
