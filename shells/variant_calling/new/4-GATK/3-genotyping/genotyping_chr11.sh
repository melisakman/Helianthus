...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr11.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr11.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr11 \
-O chr11_GATK.vcf \
-L HanXRQChr11 \
