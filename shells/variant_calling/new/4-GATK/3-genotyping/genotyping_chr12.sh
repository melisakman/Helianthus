...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr12.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr12.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr12 \
-O chr12_GATK.vcf \
-L HanXRQChr12 \
