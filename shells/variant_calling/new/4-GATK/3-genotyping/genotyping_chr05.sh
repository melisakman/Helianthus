...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr05.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr05.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr05 \
-O chr05_GATK.vcf \
-L HanXRQChr05 \
