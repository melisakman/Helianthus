...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr15.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr15.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr15 \
-O chr15_GATK.vcf \
-L HanXRQChr15 \
