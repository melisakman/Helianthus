...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr14.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr14.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr14 \
-O chr14_GATK.vcf \
-L HanXRQChr14 \
