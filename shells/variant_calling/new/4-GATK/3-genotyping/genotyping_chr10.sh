...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr10.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr10.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr10 \
-O chr10_GATK.vcf \
-L HanXRQChr10 \
