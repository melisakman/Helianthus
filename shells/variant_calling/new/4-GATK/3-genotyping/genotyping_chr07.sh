...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr07.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr07.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr07 \
-O chr07_GATK.vcf \
-L HanXRQChr07 \
