...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr02.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr02.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr02 \
-O chr02_GATK.vcf \
-L HanXRQChr02 \
