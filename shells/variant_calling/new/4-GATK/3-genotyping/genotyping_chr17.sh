...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr17.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr17.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr17 \
-O chr17_GATK.vcf \
-L HanXRQChr17 \
