...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr13.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr13.err
...
-V gendb:///global/scratch/makman/GATK/DBI/GATK_DB_chr13 \
-O chr13_GATK.vcf \
-L HanXRQChr13 \
