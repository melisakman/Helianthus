...
mv chr14_2plus.vcf.gz chr14_2plus.vcf
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c chr14_2plus.vcf > chr14_2plus.vcf.gz

/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p vcf chr14_2plus.vcf.gz  
...
/global/scratch/makman/gatk-4.1.0.0/gatk --java-options "-Xmx64g -Djava.io.tmpdir=/global/scratch/makman/temp_files/" VariantAnnotator \
   ...
   -V chr14_2plus.vcf.gz \
   -O chr14_2plus_annot.vcf.gz \
