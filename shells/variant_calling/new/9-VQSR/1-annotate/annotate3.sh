...
#SBATCH -o /global/home/users/makman/GATK/outs/VSQR_annot_unfilt_chr03.out
#SBATCH -e /global/home/users/makman/GATK/outs/VSQR_annot_unfilt_chr03.err
...
# mv chr03_2plus.vcf.gz chr03_2plus.vcf
# /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c chr03_2plus.vcf > chr03_2plus.vcf.gz
# 
# /clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p vcf chr03_2plus.vcf.gz  
...
/global/scratch/makman/gatk-4.1.0.0/gatk --java-options "-Xmx64g -Djava.io.tmpdir=/global/scratch/makman/temp_files/" VariantAnnotator \
   ...
   -V chr03_2plus.vcf.gz \
   -O chr03_2plus_annot.vcf.gz \
