...
#SBATCH -o /global/home/users/makman/GATK/outs/VSQR_annot_unfilt_chr17.out
#SBATCH -e /global/home/users/makman/GATK/outs/VSQR_annot_unfilt_chr17.err
...
/global/scratch/makman/gatk-4.1.0.0/gatk --java-options "-Xmx64g -Djava.io.tmpdir=/global/scratch/makman/temp_files/" VariantAnnotator \
   ...
   -T VariantAnnotator \
   -V chr17_2plus.vcf.gz \
   -O chr17_2plus_annot.vcf.gz \
