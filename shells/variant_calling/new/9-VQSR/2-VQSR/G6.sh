...
# --tranches-file G6_unfiltered_all_tranches.tranches \
...
-mode SNP \
--resource 3callerscombined,known=false,training=true,truth=true,prior=10.0:truthSet/truth_GATK.vcf \
-O G6_unfiltered_90_tranches.recal \
-tranche 99 -tranche 95 -tranche 90 \
--tranches-file G6_unfiltered_90_tranches.tranches \
--rscript-file G6_unfiltered_90_tranches.plots.R
