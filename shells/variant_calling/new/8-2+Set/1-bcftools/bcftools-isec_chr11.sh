...
zcat freebayes/no_mnp/freebayes_invariant_chr11_combined.vcf.gz | bcftools filter -i 'TYPE = "snp"' | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > freebayes/no_mnp/freebayes_variants_chr11.vcf.gz


# /clusterfs/rosalind/users/makman/tabix-0.2.6/tabix gvcfs/genotyping/chr11_GATK_SNP.vcf.gz
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix freebayes/no_mnp/freebayes_variants_chr11.vcf.gz
...
freebayes/no_mnp/freebayes_variants_chr11.vcf.gz \
