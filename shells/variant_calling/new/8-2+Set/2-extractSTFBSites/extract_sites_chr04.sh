...
# chr04_2/0000.vcf.gz chr04_2/FB_ST_sites_chr04_sorted.vcf.gz | /clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-sort > chr04_2plus_update.vcf.gz
