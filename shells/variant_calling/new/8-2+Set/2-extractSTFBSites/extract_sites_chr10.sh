...
# 
# /clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-shuffle-cols -t chr10_2/0000.vcf.gz chr10_2/FB_ST_sites_chr10.vcf.gz | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > chr10_2/FB_ST_sites_chr10_sorted.vcf.gz
# 


/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p vcf chr10_2/FB_ST_sites_chr10_sorted.vcf.gz
...
java -Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files2/ -Xmx60G -jar /clusterfs/rosalind/users/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
   ...
   -T CombineVariants \
   --variant chr10_2/0000.vcf.gz \
   --variant chr10_2/FB_ST_sites_chr10_sorted.vcf.gz \
   -o chr10_2plus.vcf \
   --assumeIdenticalSamples

/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c chr10_2plus.vcf > chr10_2plus.vcf.gz
...
# chr10_2/0000.vcf.gz chr10_2/FB_ST_sites_chr10_sorted.vcf.gz | /clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-sort > chr10_2plus_update.vcf.gz
