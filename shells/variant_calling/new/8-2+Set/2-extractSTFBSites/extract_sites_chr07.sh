...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p vcf chr07_2/FB_ST_sites_chr07_sorted.vcf.gz
...
java -Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files2/ -Xmx60G -jar /clusterfs/rosalind/users/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
   ...
   -T CombineVariants \
   --variant chr07_2/0000.vcf.gz \
   --variant chr07_2/FB_ST_sites_chr07_sorted.vcf.gz \
   -o chr07_2plus.vcf \
