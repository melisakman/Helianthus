...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix freebayes/freebayes_variants_chr09_filtered.vcf.gz
...
freebayes/freebayes_variants_chr09_filtered.vcf.gz \
