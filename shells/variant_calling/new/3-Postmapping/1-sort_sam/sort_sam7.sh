...
java -Djava.io.tmpdir=/global/scratch/makman/temp_files/ -Xmx54G -jar /clusterfs/vector/home/groups/software/sl-7.x86_64/modules/picard/2.9.0/lib/picard.jar SortSam INPUT=Hopi_mapping_parent.sam OUTPUT=Hopi_mapping_parent_sorted.bam SORT_ORDER=coordinate 
