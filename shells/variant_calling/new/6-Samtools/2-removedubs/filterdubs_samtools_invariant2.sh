...
python ~/git/Helianthus/shells/variant_calling/samtools_VC/13-filter/samtools_filter_by_qual.py samtools_invariant_chr02.vcf samtools_invariant_chr02_dupsRemoved.vcf
