...
python ~/git/Helianthus/shells/variant_calling/samtools_VC/13-filter/samtools_filter_by_qual.py samtools_invariant_chr02_fixed.vcf samtools_invariant_chr02_dupsRemoved.vcf
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c samtools_invariant_chr02_dupsRemoved.vcf > samtools_invariant_chr02_dupsRemoved.vcf.gz
