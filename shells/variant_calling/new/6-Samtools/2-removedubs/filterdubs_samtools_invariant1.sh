...
python ~/git/Helianthus/shells/variant_calling/old/samtools_VC/13-filter/samtools_filter_by_qual.py samtools_invariant_chr01_combined.vcf samtools_invariant_chr01_dupsRemoved.vcf
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c samtools_invariant_chr01_dupsRemoved.vcf > samtools_invariant_chr01_dupsRemoved.vcf.gz
