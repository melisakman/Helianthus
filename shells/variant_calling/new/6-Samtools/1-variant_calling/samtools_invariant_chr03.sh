...
bcftools mpileup -Ou --max-depth 100 -f /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta -r HanXRQChr03 \
...
ann1238_lane2_62_5M_markdup_readGroup.bam | bcftools call -Oz -m > ../samtools/samtools_invariant_chr03.vcf.gz