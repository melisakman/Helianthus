...
#SBATCH -o /global/home/users/makman/GATK/outs/samtools_invariant_chr14b.out
#SBATCH -e /global/home/users/makman/GATK/outs/samtools_invariant_chr14b.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
module load bcftools/1.6
TMPDIR=/global/scratch/makman/temp
bcftools mpileup -Ou --max-depth 100 -f /clusterfs/rosalind/users/makman/HanXRQr2/HanXRQr2.0-SUNRISE-2.1.genome.fasta -r HanXRQChr14 \
...
ann1238_lane2_62_5M_markdup_readGroup.bam | bcftools call -Oz -m > ../samtools/samtools_invariant_chr14.vcf.gz