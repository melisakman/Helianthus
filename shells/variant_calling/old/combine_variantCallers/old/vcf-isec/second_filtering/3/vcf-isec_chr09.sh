#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bcftools_isec/secondFilter/vcf-isec_chr09_3
#SBATCH -J isecchr09
...
#SBATCH -o /global/home/users/makman/GATK/outs/chr09_vcf-isec_3.out
#SBATCH -e /global/home/users/makman/GATK/outs/chr09_vcf-isec_3.err
...
0000_renamed.vcf.gz 0001_sorted.vcf.gz 0002_sorted.vcf.gz | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > chr09_intersect_3.vcf.gz
