...
#SBATCH -o /global/home/users/makman/GATK/outs/vcf-isec_chr02_hardfilter.out
#SBATCH -e /global/home/users/makman/GATK/outs/vcf-isec_chr02_hardfilter.err
...
gunzip fastq/invariants/filtered_combined/VCMA_GATK_chr02_sorted.vcf.gz
...
# 
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c fastq/invariants/filtered_combined/VCMA_GATK_chr02_sorted.vcf > fastq/invariants/filtered_combined/VCMA_GATK_chr02_sorted.vcf.gz
...
# 
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix ./fastq/invariants/filtered_combined/VCMA_GATK_chr02_sorted.vcf.gz
...
bcftools isec -n +2 -O z -p vcf-isec_chr02_hardFilter fastq/invariants/filtered_combined/VCMA_GATK_chr02_sorted.vcf.gz \
