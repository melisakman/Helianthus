...
gunzip fastq/invariants/filtered_combined/VCMA_GATK_chr01_nonstringentFilter.vcf.gz
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c fastq/invariants/filtered_combined/VCMA_GATK_chr01_nonstringentFilter.vcf > fastq/invariants/filtered_combined/VCMA_GATK_chr01_nonstringentFilter.vcf.gz
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix ./fastq/invariants/filtered_combined/VCMA_GATK_chr01_nonstringentFilter.vcf.gz
...
bcftools isec -n +2 -O z -p vcf-isec_chr01 fastq/invariants/filtered_combined/VCMA_GATK_chr01_nonstringentFilter.vcf.gz \
