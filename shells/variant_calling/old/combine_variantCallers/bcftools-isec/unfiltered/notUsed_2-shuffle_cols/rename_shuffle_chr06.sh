#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bcftools_isec/unfiltered/chr06_2
#SBATCH -J shfchr06
...
#SBATCH --time=8:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/rename_shuffle_chr06.out
#SBATCH -e /global/home/users/makman/GATK/outs/rename_shuffle_chr06.err
