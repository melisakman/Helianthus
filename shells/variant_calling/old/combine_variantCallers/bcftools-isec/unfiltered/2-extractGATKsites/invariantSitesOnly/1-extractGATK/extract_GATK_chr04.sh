...
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c /clusterfs/rosalind/users/makman/GATK/bcftools_isec/unfiltered/chr04_unfiltered_2plus_GATK_invariantSitesOnly.vcf > /clusterfs/rosalind/users/makman/GATK/bcftools_isec/unfiltered/chr04_unfiltered_2plus_GATK_invariantSitesOnly.vcf.gz
