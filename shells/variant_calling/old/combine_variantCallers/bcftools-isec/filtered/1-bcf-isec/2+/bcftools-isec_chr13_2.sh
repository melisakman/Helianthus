...
# /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c samtools_VC/samtools_invariant_chr13_Filtered.vcf > samtools_VC/samtools_invariant_chr13_Filtered.vcf.gz
# 
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix samtools_VC/samtools_invariant_chr13_Filtered.vcf.gz

bcftools isec -n +2 -O z -p bcftools_isec/chr13_2 fastq/invariants/filtered_combined/VCMA_GATK_chr13_secondFilter.vcf.gz \
samtools_VC/samtools_invariant_chr13_Filtered.vcf.gz \
