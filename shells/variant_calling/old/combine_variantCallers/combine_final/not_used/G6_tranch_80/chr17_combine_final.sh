...
bcftools filter -r HanXRQChr17 -i 'TYPE = "snp"' unfiltered_2plus_GATK_annot_VSQR80_G6.vcf.gz | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > VQSRfiltered_80_G6_SNP_chr17.vcf.gz


export PERL5LIB=/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/perl/

/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-concat \
VQSRfiltered_80_G6_SNP_chr17.vcf.gz \
../filtered_90_G4_indelRef_chr17.vcf.gz | vcf-sort -t /clusterfs/rosalind/users/makman/temp \
| /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > ../final/G6_80/chr17_final.vcf.gz
