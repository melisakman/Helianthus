...
#SBATCH --mem=36000
#SBATCH --time=9:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/fastqc_trim4.out
#SBATCH -e /global/home/users/makman/GATK/outs/fastqc_trim4.err
...
fastqc HA442_R1_trimmed_fastq.gz
fastqc HA442_R2_trimmed_fastq.gz
fastqc HA821_R1_trimmed_fastq.gz
fastqc HA821_R2_trimmed_fastq.gz
