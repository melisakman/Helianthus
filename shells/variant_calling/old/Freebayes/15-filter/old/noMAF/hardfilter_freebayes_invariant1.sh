...
cat old/freebayes_invariant_chr01_all.vcf | vcftools --vcf - --minDP 3 --max-missing 0.8 --maxDP 25 --recode --stdout > freebayes_invariant_chr01_allFiltered_onlyvcftools.vcf
