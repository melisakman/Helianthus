...
#SBATCH -o /global/home/users/makman/GATK/outs/qual_by_depth_freebayes2.out
#SBATCH -e /global/home/users/makman/GATK/outs/qual_by_depth_freebayes2.err
...
zcat old/freebayes_invariant_chr05_secondtime_combined.vcf.gz | bcftools filter -g 5 -i 'TYPE = "snp" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "indel" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "mnp" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "ref" && QUAL < 0.0000434' | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > freebayes_invariant_chr05_qual_by_depth.vcf.gz
zcat old/freebayes_invariant_chr06_secondtime_combined.vcf.gz | bcftools filter -g 5 -i 'TYPE = "snp" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "indel" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "mnp" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "ref" && QUAL < 0.0000434' | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > freebayes_invariant_chr06_qual_by_depth.vcf.gz
...
zcat old/freebayes_invariant_chr09_combined.vcf.gz | bcftools filter -g 5 -i 'TYPE = "snp" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "indel" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "mnp" && QUAL/DP > 2.0 && QUAL > 50 || TYPE = "ref" && QUAL < 0.0000434' | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > freebayes_invariant_chr09_qual_by_depth.vcf.gz
