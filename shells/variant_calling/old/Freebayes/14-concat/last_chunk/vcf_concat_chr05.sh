...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_vcf_concat_chr05_all.out
#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_vcf_concat_chr05_all.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
export PERL5LIB=/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/perl/
TMPDIR=/clusterfs/rosalind/users/makman/temp
/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-concat \
freebayes_invariant_chr05_combined.vcf freebayes_invariant_chr05_chunk28.vcf > freebayes_invariant_chr05_combined_end.vcf
