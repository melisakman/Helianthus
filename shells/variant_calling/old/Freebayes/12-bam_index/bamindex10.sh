...
#SBATCH -o /global/home/users/makman/GATK/outs/bamindex10.out
#SBATCH -e /global/home/users/makman/GATK/outs/bamindex10.err
...
samtools index Zuni_sorted_markdup_recal_RG.bam Zuni_sorted_markdup_recal_RG.bai
