...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr17_mex.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr17_mex.err
...
--variant Hopi_real_chr17.g.vcf.gz \
