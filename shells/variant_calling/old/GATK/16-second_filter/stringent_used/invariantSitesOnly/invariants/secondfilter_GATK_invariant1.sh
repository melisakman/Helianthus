...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_GATK1_secondFilter_onlyInvariantSites.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_GATK1_secondFilter_onlyInvariantSites.err
...
# cat VCMA_chr01_NO_VARIATION_hardfiltered.vcf | vcftools --vcf - --minDP 1 --max-missing 0.8 --maxDP 30 --recode --stdout | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > VCMA_GATK_chr01_secondFilter_onlyInvariantSites.vcf.gz
...
zcat VCMA_GATK_chr02_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr02_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr03_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr04_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr05_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr06_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr07_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr08_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr09_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr10_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr11_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr12_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr13_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr14_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr15_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr16_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
zcat VCMA_GATK_chr17_secondFilter_onlyInvariantSites.vcf.gz | tail -n 1
