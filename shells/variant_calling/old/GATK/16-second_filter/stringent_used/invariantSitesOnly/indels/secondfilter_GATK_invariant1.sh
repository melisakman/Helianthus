...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_GATK1_secondFilter_onlyIndelSites.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_GATK1_secondFilter_onlyIndelSites.err
