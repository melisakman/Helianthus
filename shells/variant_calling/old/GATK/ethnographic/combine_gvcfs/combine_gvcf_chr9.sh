...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr09_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr09_ethno.err
...
-O combined_chr09_ethno.g.vcf.gz
