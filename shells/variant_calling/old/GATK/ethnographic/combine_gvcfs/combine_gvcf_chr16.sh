...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr16_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr16_ethno.err
...
-O combined_chr16_ethno.g.vcf.gz
