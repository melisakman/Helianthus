...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr15_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr15_ethno.err
...
-O combined_chr15_ethno.g.vcf.gz
