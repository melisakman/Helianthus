...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr08_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr08_ethno.err
...
-O combined_chr08_ethno.g.vcf.gz
