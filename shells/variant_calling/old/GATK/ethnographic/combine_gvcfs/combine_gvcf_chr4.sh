...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr04_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr04_ethno.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All

module load java

/clusterfs/rosalind/users/makman/gatk-4.0.0.0/gatk --java-options "-Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files2/ -Xmx60G" CombineGVCFs \
...
--variant Hopi_real_chr04.g.vcf.gz \
...
-O combined_chr04_ethno.g.vcf.gz
