...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr06_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr06_ethno.err
...
-O combined_chr06_ethno.g.vcf.gz
