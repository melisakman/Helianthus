...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr01_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr01_ethno.err
...
-O combined_chr01_ethno.g.vcf.gz
