...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr05_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr05_ethno.err
...
-O combined_chr05_ethno.g.vcf.gz
