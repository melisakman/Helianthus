...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr03_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr03_ethno.err
...
--variant Hopi_real_chr03.g.vcf.gz \
...
-O combined_chr03_ethno.g.vcf.gz
