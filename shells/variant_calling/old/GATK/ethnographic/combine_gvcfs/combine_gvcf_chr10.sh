...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr10_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr10_ethno.err
...
-O combined_chr10_ethno.g.vcf.gz
