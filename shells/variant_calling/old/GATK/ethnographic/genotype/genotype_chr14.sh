...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr14_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr14_ethno.err
...
-V combined_chr14_ethno.g.vcf.gz \
-O VC_MA_chr14_ethno.vcf.gz