...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr15_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr15_ethno.err
...
-V combined_chr15_ethno.g.vcf.gz \
-O VC_MA_chr15_ethno.vcf.gz