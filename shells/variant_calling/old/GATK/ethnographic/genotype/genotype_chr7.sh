...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr7_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr7_ethno.err
...
-V combined_chr07_ethno.g.vcf.gz \
-O VC_MA_chr07_ethno.vcf.gz