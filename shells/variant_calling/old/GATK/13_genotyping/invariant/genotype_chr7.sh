...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr7_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr7_invariant.err
...
-L HanXRQChr07 --includeNonVariantSites \
...
--variant Hopi_real_chr07.g.vcf.gz \
...
-o ../../invariants/VCMA_chr07.vcf.gz