...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr6_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr6_invariant.err
...
-L HanXRQChr06 --includeNonVariantSites \
...
--variant Hopi_real_chr06.g.vcf.gz \
...
-o ../../invariants/VCMA_chr06.vcf.gz