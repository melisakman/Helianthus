...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr16_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr16_invariant.err
...
-L HanXRQChr16 --includeNonVariantSites \
...
--variant Hopi_real_chr16.g.vcf.gz \
...
-o ../../invariants/VCMA_chr16.vcf.gz