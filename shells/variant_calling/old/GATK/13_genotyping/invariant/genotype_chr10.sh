...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr10_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr10_invariant.err
...
-L HanXRQChr10 --includeNonVariantSites \
...
--variant Hopi_real_chr10.g.vcf.gz \
...
-o ../../invariants/VCMA_chr10.vcf.gz