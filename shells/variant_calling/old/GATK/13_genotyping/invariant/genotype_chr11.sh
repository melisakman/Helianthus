...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr11_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr11_invariant.err
...
-L HanXRQChr11 --includeNonVariantSites \
...
--variant Hopi_real_chr11.g.vcf.gz \
...
-o ../../invariants/VCMA_chr11.vcf.gz