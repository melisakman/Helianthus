...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr13_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr13_invariant.err
...
-L HanXRQChr13 --includeNonVariantSites \
...
--variant Hopi_real_chr13.g.vcf.gz \
...
-o ../../invariants/VCMA_chr13.vcf.gz