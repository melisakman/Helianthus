...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr14_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr14_invariant.err
...
-L HanXRQChr14 --includeNonVariantSites \
...
--variant Hopi_real_chr14.g.vcf.gz \
...
-o ../../invariants/VCMA_chr14.vcf.gz