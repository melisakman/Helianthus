...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr15_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr15_invariant.err
...
-L HanXRQChr15 --includeNonVariantSites \
...
--variant Hopi_real_chr15.g.vcf.gz \
...
-o ../../invariants/VCMA_chr15.vcf.gz