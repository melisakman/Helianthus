...
#SBATCH -o /global/home/users/makman/GATK/outs/freebayes_vcf_concat_chr08_all.out
#SBATCH -e /global/home/users/makman/GATK/outs/freebayes_vcf_concat_chr08_all.err
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c freebayes_invariant_chr08_AnzacPueblo.vcf > freebayes_invariant_chr08_AnzacPueblo.vcf.gz 

/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p vcf freebayes_invariant_chr08_combined.vcf.gz  
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p vcf freebayes_invariant_chr08_AnzacPueblo.vcf.gz  


/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-merge \
freebayes_invariant_chr08_combined.vcf.gz freebayes_invariant_chr08_AnzacPueblo.vcf.gz > freebayes_invariant_chr08_all.vcf.gz
