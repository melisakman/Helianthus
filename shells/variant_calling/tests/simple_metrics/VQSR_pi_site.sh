...
vcftools --vcf chr01_final.vcf --site-pi --keep ../lr_list.txt --out pi/lr_pi_chr01_10kb
...
../
vcftools --vcf chr01_final.vcf --site-pi --keep ../wd_list.txt --out pi/wd_pi_chr01_10kb
