...
# /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c samtools_VC/samtools_invariant_chr06_Filtered.vcf > samtools_VC/samtools_invariant_chr06_Filtered.vcf.gz
# 
...
# /clusterfs/rosalind/users/makman/tabix-0.2.6/tabix samtools_VC/samtools_invariant_chr06_Filtered.vcf.gz

bcftools isec -n =3 -O z -p bcftools_isec/chr06_3 fastq/invariants/filtered_combined/VCMA_GATK_chr06_secondFilter.vcf.gz \
samtools_VC/samtools_invariant_chr06_Filtered.vcf.gz \
