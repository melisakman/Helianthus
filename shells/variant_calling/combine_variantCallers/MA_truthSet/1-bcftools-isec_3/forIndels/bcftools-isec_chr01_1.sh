...
#SBATCH --time=8:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/bcf-isec_chr01_1.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcf-isec_chr01_1.err
...
bcftools isec -n +1 -O z -p bcftools_isec/chr01_1 fastq/invariants/filtered_combined/VCMA_GATK_chr01_secondFilter.vcf.gz \
