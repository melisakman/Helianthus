...
# /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c fastq/invariants/filtered_combined/VCMA_chr16_secondFilter.vcf > fastq/invariants/filtered_combined/VCMA_chr16_secondFilter.vcf.gz
...
# 
# /clusterfs/rosalind/users/makman/tabix-0.2.6/tabix fastq/invariants/filtered_combined/VCMA_chr16_secondFilter.vcf.gz
...
bcftools isec -n +2 -O z -p bcftools_isec/chr16_2 fastq/invariants/filtered_combined/VCMA_chr16_secondFilter.vcf.gz \
