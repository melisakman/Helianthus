#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bcftools_isec/unfiltered/chr03_2
#SBATCH -J shfchr03
...
#SBATCH --time=8:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/rename_shuffle_chr03.out
#SBATCH -e /global/home/users/makman/GATK/outs/rename_shuffle_chr03.err
