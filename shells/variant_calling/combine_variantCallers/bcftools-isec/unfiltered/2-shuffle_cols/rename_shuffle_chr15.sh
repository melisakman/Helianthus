#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bcftools_isec/unfiltered/chr15_2
#SBATCH -J shfchr15
...
#SBATCH --time=8:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/rename_shuffle_chr15.out
#SBATCH -e /global/home/users/makman/GATK/outs/rename_shuffle_chr15.err
