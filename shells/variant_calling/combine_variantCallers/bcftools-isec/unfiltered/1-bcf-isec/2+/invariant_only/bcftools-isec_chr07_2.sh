...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix fastq/invariants/VCMA_GATK_chr07_secondFilter_onlyInvariantSites.vcf.gz

bcftools isec -n +2 -O z -p bcftools_isec/unfiltered/invariantSitesOnly/chr07_2 fastq/invariants/VCMA_GATK_chr07_secondFilter_onlyInvariantSites.vcf.gz \
