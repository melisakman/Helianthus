...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix samtools_VC/old/samtools_invariant_chr04_combined.vcf.gz
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix freebayes/final_combined/old/freebayes_invariant_chr04_all.vcf.gz

bcftools isec -n +2 -O z -p bcftools_isec/chr04_2 fastq/invariants/VCMA_chr04.vcf.gz \
samtools_VC/old/samtools_invariant_chr04_combined.vcf.gz \
