#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bcftools_isec/chr13_2
#SBATCH -J chr13
...
#SBATCH --time=8:00:00
#SBATCH -o /global/home/users/makman/GATK/outs/chr13_vcf-isec.out
#SBATCH -e /global/home/users/makman/GATK/outs/chr13_vcf-isec.err
...
0000_renamed.vcf.gz 0001_sorted.vcf.gz 0002_sorted.vcf.gz | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > chr13_intersect.vcf.gz
