...
#SBATCH -o /global/home/users/makman/GATK/outs/VSQR_annot_filt_chr10.out
#SBATCH -e /global/home/users/makman/GATK/outs/VSQR_annot_filt_chr10.err
...
java -Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files2/ -Xmx60G -jar /clusterfs/rosalind/users/makman/GenomeAnalysisTK-3.7-0/GenomeAnalysisTK.jar \
   ...
   -T VariantAnnotator \
   -V chr10_filtered_2plus_GATK.vcf.gz \
