...
--max-gaussians 4 \
-mode SNP \
--resource 3callerscombined,known=false,training=true,truth=true,prior=20.0:../truthSet/truth_GATK_variants.vcf \
-O prior20_unfiltered_all.recal \
--tranches-file prior20_unfiltered_all.tranches \
--rscript-file prior20_unfiltered_all.plots.R
