...
#SBATCH -o /global/home/users/makman/GATK/outs/VSQR_annot_filt_chr01.out
#SBATCH -e /global/home/users/makman/GATK/outs/VSQR_annot_filt_chr01.err
...
#    -T VariantAnnotator \
#    -V chr01_filtered_2plus_GATK.vcf.gz \
