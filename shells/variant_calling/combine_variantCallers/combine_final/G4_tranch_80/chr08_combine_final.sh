...
# bcftools filter -i 'TYPE = "indel" || TYPE = "ref"' ../chr08_filtered_2plus_GATK_annot.vcf.gz | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > ../filtered_80_G4_indelRef_chr08.vcf.gz

export PERL5LIB=/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/perl/

/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-concat \
VQSRfiltered_80_G4_SNP_chr08.vcf.gz \
../filtered_80_G4_indelRef_chr08.vcf.gz | vcf-sort -t /clusterfs/rosalind/users/makman/temp \
