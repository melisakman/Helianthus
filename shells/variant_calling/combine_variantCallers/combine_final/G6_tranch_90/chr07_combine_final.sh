...
bcftools filter -r HanXRQChr07 -i 'TYPE = "snp"' unfiltered_2plus_GATK_annot_VSQR90_G6.vcf.gz | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > VQSRfiltered_90_G6_SNP_chr07.vcf.gz


export PERL5LIB=/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/perl/

/clusterfs/vector/home/groups/software/sl-6.x86_64/modules/vcftools/0.1.13/bin/vcf-concat \
VQSRfiltered_90_G6_SNP_chr07.vcf.gz \
../filtered_90_G4_indelRef_chr07.vcf.gz | vcf-sort -t /clusterfs/rosalind/users/makman/temp \
| /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > ../final/G6_90/chr07_final.vcf.gz
