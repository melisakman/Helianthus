...
/clusterfs/rosalind/users/makman/GATK/freebayes/final_combined/freebayes_invariantSites_chr05_bcftools_sites.vcf \
VQSRfiltered_90_G4_SNP_chr05.vcf.gz \
chr05_unfiltered_2plus_GATK_invariantSitesOnly_noIndels.vcf.gz \
