...
python ~/git/Helianthus/shells/variant_calling/samtools_VC/12-filter/samtools_filter_by_qual.py samtools_invariant_chr02_fixed.vcf samtools_invariant_chr02_dupsRemoved.vcf
