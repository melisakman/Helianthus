...
# zcat old/samtools_invariant_chr10.vcf.gz | bcftools filter -g 5 -i 'TYPE = "ref" && QUAL/DP > 2.0 && QUAL > 20 && MQ > 40' | vcftools --vcf - --minDP 1 --max-missing 0.8 --maxDP 30 --recode --stdout | vcf-sort -t /clusterfs/rosalind/users/makman/temp | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > samtools_invariant_chr10_Filtered_invariantSitesOnly.vcf.gz
# zcat old/samtools_invariant_chr11.vcf.gz | bcftools filter -g 5 -i 'TYPE = "ref" && QUAL/DP > 2.0 && QUAL > 20 && MQ > 40' | vcftools --vcf - --minDP 1 --max-missing 0.8 --maxDP 30 --recode --stdout | vcf-sort -t /clusterfs/rosalind/users/makman/temp | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > samtools_invariant_chr11_Filtered_invariantSitesOnly.vcf.gz
# zcat old/samtools_invariant_chr12.vcf.gz | bcftools filter -g 5 -i 'TYPE = "ref" && QUAL/DP > 2.0 && QUAL > 20 && MQ > 40' | vcftools --vcf - --minDP 1 --max-missing 0.8 --maxDP 30 --recode --stdout | vcf-sort -t /clusterfs/rosalind/users/makman/temp | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > samtools_invariant_chr12_Filtered_invariantSitesOnly.vcf.gz
# zcat old/samtools_invariant_chr13.vcf.gz | bcftools filter -g 5 -i 'TYPE = "ref" && QUAL/DP > 2.0 && QUAL > 20 && MQ > 40' | vcftools --vcf - --minDP 1 --max-missing 0.8 --maxDP 30 --recode --stdout | vcf-sort -t /clusterfs/rosalind/users/makman/temp | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > samtools_invariant_chr13_Filtered_invariantSitesOnly.vcf.gz
...
zcat samtools_invariant_chr01_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr02_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr03_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr04_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr05_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr06_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr07_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr08_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr09_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr10_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr11_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr12_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr13_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr14_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr15_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr16_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
zcat samtools_invariant_chr17_Filtered_invariantSitesOnly.vcf.gz | tail -n 1
