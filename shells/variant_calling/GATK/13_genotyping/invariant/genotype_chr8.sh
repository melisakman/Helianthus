...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr8_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr8_invariant.err
...
-L HanXRQChr08 --includeNonVariantSites \
...
-o ../../invariants/VCMA_chr08.vcf.gz