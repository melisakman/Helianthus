...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr12_invariant.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr12_invariant.err
...
-L HanXRQChr12 --includeNonVariantSites \
...
--variant Hopi_real_chr12.g.vcf.gz \
...
-o ../../invariants/VCMA_chr12.vcf.gz