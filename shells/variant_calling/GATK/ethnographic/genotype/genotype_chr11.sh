...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr11_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr11_ethno.err
...
-V combined_chr11_ethno.g.vcf.gz \
-O VC_MA_chr11_ethno.vcf.gz