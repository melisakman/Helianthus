...
#SBATCH -o /global/home/users/makman/GATK/outs/genotype_chr10_ethno.out
#SBATCH -e /global/home/users/makman/GATK/outs/genotype_chr10_ethno.err
...
-V combined_chr10_ethno.g.vcf.gz \
-O VC_MA_chr10_ethno.vcf.gz