...
#SBATCH -o /global/home/users/makman/GATK/outs/variant_cal_mex5.out
#SBATCH -e /global/home/users/makman/GATK/outs/variant_cal_mex5.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
module load java

# /clusterfs/rosalind/users/makman/gatk-4.0.0.0/gatk --java-options "-Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files/ -Xmx64G" HaplotypeCaller -R /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -I Mex_A1516_sorted_markdup_readGroups_recal.bam -O Mex_A1516.g.vcf.gz -ERC GVCF
...
/clusterfs/rosalind/users/makman/gatk-4.0.0.0/gatk --java-options "-Djava.io.tmpdir=/clusterfs/rosalind/users/makman/temp_files/ -Xmx40G" HaplotypeCaller -R /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -I Mex_Ann261_sorted_markdup_readGroups_recal.bam -O Mex_Ann261.g.vcf.gz -ERC GVCF
