...
#SBATCH -o /global/home/users/makman/GATK/outs/combine_gvcfs_chr11_mex.out
#SBATCH -e /global/home/users/makman/GATK/outs/combine_gvcfs_chr11_mex.err
