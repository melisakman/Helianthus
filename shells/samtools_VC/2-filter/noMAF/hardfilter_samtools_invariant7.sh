...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_samtools7noMAF.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_samtools7noMAF.err
