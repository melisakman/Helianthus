...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_samtools3noMAF.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_samtools3noMAF.err
