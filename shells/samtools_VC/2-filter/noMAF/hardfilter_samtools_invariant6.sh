...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_samtools6noMAF.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_samtools6noMAF.err
