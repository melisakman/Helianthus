...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_samtools1noMAF.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_samtools1noMAF.err
