...
#SBATCH -o /global/home/users/makman/GATK/outs/bcftools_filter_samtools2noMAF.out
#SBATCH -e /global/home/users/makman/GATK/outs/bcftools_filter_samtools2noMAF.err
