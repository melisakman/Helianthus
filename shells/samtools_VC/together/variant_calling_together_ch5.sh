...
#SBATCH -o /global/home/users/makman/GATK/outs/samtools_combined_chr05.out
#SBATCH -e /global/home/users/makman/GATK/outs/samtools_combined_chr05.err
...
bcftools mpileup -Ou -f HanXRQChr05 /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa Anzac_Pueblo_sorted_markdup_recal_RG.bam \
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam | bcftools call -Oz > ../samtools_VC/samtools_combined_chr07.vcf.gz
