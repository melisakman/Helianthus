...
interval = 80000000
bins = int(chr_length/interval) + 2

iterations = range(1,bins)
border_l = 1
border_r = interval
for i in iterations:
	file_name = "samtools_invariant_chr" + str(chr) + "_chunk" + str(i) + ".sh"
	file = open(file_name, 'w')
	file.write("""#!/bin/bash
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bams
#SBATCH -J st""" + str(chr) + "-" + str(i) +
...
#SBATCH -o /global/home/users/makman/GATK/outs/samtools_invariant_chr""" + str(chr) + "_chunk" + str(i) + ".out" +
"""\n#SBATCH -e /global/home/users/makman/GATK/outs/samtools_invariant_chr""" + str(chr) +"_chunk" + str(i) + ".err" +
"""\n#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
module load bcftools/1.6
TMPDIR=/clusterfs/rosalind/users/makman/temp
bcftools mpileup -Ou --max-depth 100 -f /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -r HanXRQChr""" + str(chr) + ":" + str(border_l) + "-" + str(border_r) + " \\" +
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam | bcftools call -Ozm > ../samtools_VC/samtools_combined_chr""" + str(chr) + "_chunk" + str(i) + ".vcf.gz")
	border_l = border_l + interval
	border_r = border_r + interval
