...
#SBATCH -o /global/home/users/makman/GATK/outs/samtools_invariant_chr16.out
#SBATCH -e /global/home/users/makman/GATK/outs/samtools_invariant_chr16.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All
module load bcftools/1.6
TMPDIR=/clusterfs/rosalind/users/makman/temp
bcftools mpileup -Ou --max-depth 100 -f /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa -r HanXRQChr16 \
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam | bcftools call -Oz -m > ../samtools_VC/samtools_invariant_chr16.vcf.gz