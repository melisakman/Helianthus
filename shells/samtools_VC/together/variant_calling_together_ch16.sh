...
#SBATCH -o /global/home/users/makman/GATK/outs/samtools_combined_chr16.out
#SBATCH -e /global/home/users/makman/GATK/outs/samtools_combined_chr16.err
...
samtools mpileup -uf -r HanXRQChr16 /clusterfs/rosalind/users/makman/HanXRQr1.0-20151230.fa Anzac_Pueblo_sorted_markdup_recal_RG.bam \
...
Mex_Ann261_sorted_markdup_readGroups_recal_RG.bam | bcftools view -bvcg - > ../samtools_VC/samtools_combined_chr16.bcf
