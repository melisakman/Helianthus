...
#SBATCH --time=4:00:00
#SBATCH -o /global/home/users/makman/vcftools/outs/vcftools_VCMA_fst_compareFiltering.out
#SBATCH -e /global/home/users/makman/vcftools/outs/vcftools_VCMA_fst_compareFiltering.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All

module load bio/vcftools/0.1.15

vcftools --gzvcf secondFilter/vcf-isec_chr01/chr01_intersect.vcf.gz --weir-fst-pop secondFilter/wd_list.txt --weir-fst-pop secondFilter/lr_list.txt --fst-window-size 10000 --out ../compare_filtering/second_filtering_2
...
vcftools --gzvcf ../fastq/invariants/filtered_combined/VCMA_GATK_chr01_secondFilter.vcf.gz --weir-fst-pop secondFilter/wd_list.txt --weir-fst-pop secondFilter/lr_list.txt --fst-window-size 10000 --out ../compare_filtering/GATK_second
