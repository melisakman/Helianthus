#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bcftools_isec/secondFilter/vcf-isec_chr01_3
#SBATCH -J isecchr01
...
#SBATCH -o /global/home/users/makman/GATK/outs/chr01_vcf-isec_3.out
#SBATCH -e /global/home/users/makman/GATK/outs/chr01_vcf-isec_3.err
