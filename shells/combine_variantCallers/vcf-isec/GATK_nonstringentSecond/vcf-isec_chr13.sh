...
#SBATCH -o /global/home/users/makman/GATK/outs/vcf-isec_chr13.out
#SBATCH -e /global/home/users/makman/GATK/outs/vcf-isec_chr13.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All

module load bcftools/1.6

gunzip fastq/invariants/filtered_combined/VCMA_GATK_chr13_nonstringentFilter.vcf.gz
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c fastq/invariants/filtered_combined/VCMA_GATK_chr13_nonstringentFilter.vcf > fastq/invariants/filtered_combined/VCMA_GATK_chr13_nonstringentFilter.vcf.gz
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix ./fastq/invariants/filtered_combined/VCMA_GATK_chr13_nonstringentFilter.vcf.gz
...
bcftools isec -n +2 -O z -p vcf-isec_chr13 fastq/invariants/filtered_combined/VCMA_GATK_chr13_nonstringentFilter.vcf.gz \
