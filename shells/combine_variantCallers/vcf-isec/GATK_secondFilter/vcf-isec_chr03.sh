...
gunzip fastq/invariants/filtered_combined/VCMA_GATK_chr03_secondFilter.vcf.gz
...
bcftools isec -n +2 -O z -p vcf-isec_chr03 fastq/invariants/filtered_combined/VCMA_GATK_chr03_secondFilter.vcf.gz \
