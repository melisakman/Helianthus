...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p fastq/invariants/filtered_combined/VCMA_GATK_chr02_secondFilter.vcf.gz
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p freebayes/final_combined/freebayes_invariant_chr02_allFiltered.vcf.gz
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix -p samtools_VC/samtools_invariant_chr02_Filtered.vcf.gz
