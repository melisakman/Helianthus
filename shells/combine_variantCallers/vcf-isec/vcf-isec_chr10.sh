...
gunzip fastq/invariants/filtered_combined/VCMA_GATK_chr10_secondFilter.vcf.gz
...
bcftools isec -n 2+ -O z -p vcf-isec_chr10 fastq/invariants/filtered_combined/VCMA_GATK_chr10_secondFilter.vcf.gz \
