...
#SBATCH -o /global/home/users/makman/GATK/outs/vcf-isec_chr10_hardfilter.out
#SBATCH -e /global/home/users/makman/GATK/outs/vcf-isec_chr10_hardfilter.err
#SBATCH --mail-user=makman@berkeley.edu
#SBATCH --mail-type=All

module load bcftools/1.6

# gunzip fastq/invariants/filtered_combined/VCMA_GATK_chr10_sorted.vcf.gz
...
# 
# /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c fastq/invariants/filtered_combined/VCMA_GATK_chr10_sorted.vcf > fastq/invariants/filtered_combined/VCMA_GATK_chr10_sorted.vcf.gz
...
/clusterfs/rosalind/users/makman/tabix-0.2.6/tabix ./fastq/invariants/filtered_combined/VCMA_GATK_chr10_sorted.vcf.gz
...
bcftools isec -n +2 -O z -p vcf-isec_chr10_hardFilter fastq/invariants/filtered_combined/VCMA_GATK_chr10_sorted.vcf.gz \
