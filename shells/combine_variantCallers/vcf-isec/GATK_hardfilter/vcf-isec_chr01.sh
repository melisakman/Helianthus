...
#SBATCH -o /global/home/users/makman/GATK/outs/vcf-isec_chr01_hardfilter.out
#SBATCH -e /global/home/users/makman/GATK/outs/vcf-isec_chr01_hardfilter.err
...
bcftools isec -n +2 -O z -p vcf-isec_chr01_hardFilter fastq/invariants/filtered_combined/VCMA_GATK_chr01_sorted.vcf.gz \
