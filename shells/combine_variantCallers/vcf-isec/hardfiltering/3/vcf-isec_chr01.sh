#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bcftools_isec/hardFilter/vcf-isec_chr01_hardFilter_3
#SBATCH -J isecchr01
...
#SBATCH -o /global/home/users/makman/GATK/outs/chr01_vcf-isec_hf3.out
#SBATCH -e /global/home/users/makman/GATK/outs/chr01_vcf-isec_hf3.err
...
0000_renamed.vcf.gz 0001_sorted.vcf.gz 0002_sorted.vcf.gz | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > chr01_intersect_3.vcf.gz
