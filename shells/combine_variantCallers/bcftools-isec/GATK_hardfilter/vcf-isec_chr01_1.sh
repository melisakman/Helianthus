...
#SBATCH -o /global/home/users/makman/GATK/outs/vcf-isec_chr01_hardfilter_1.out
#SBATCH -e /global/home/users/makman/GATK/outs/vcf-isec_chr01_hardfilter_1.err
...
bcftools isec -n +1 -O z -p vcf-isec_chr01_hardFilter_1 fastq/invariants/filtered_combined/VCMA_GATK_chr01_sorted.vcf.gz \
