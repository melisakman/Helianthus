#!/bin/bash 
#SBATCH -D /clusterfs/rosalind/users/makman/GATK/bcftools_isec/secondFilter/vcf-isec_chr02_3
...
#SBATCH -o /global/home/users/makman/GATK/outs/rename_shuffle_chr02_3.out
#SBATCH -e /global/home/users/makman/GATK/outs/rename_shuffle_chr02_3.err
