#!/bin/bash
#
#SBATCH --job-name=ngsRelate_Ethno
...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH -o /global/scratch/nwales/Sunflower_paleomix/Alred_paper/0_scripts/4_ngsRelate_Ethno.%j.out
#SBATCH -e /global/scratch/nwales/Sunflower_paleomix/Alred_paper/0_scripts/4_ngsRelate_Ethno.%j.err
#SBATCH --mail-user=nathan.wales@berkeley.edu
#SBATCH --mail-type=All

Project_name="Ethno_ngsRelate_angsd"
BAM_list="Bam_list_Ethno_for_ngsRelate.txt"
