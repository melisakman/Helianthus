...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH -o /global/scratch/nwales/Sunflower_paleomix/Alred_paper/0_scripts/5_ngsLD_All.%j.out
#SBATCH -e /global/scratch/nwales/Sunflower_paleomix/Alred_paper/0_scripts/5_ngsLD_All.%j.err
...
### Didn't try to restrict to sites well represented in the Alred samples
...
well_covered_locations <- angsd_locations[angsd_locations[, "nInd"] > (0.6666 * maximum_ind) , ]
...
# Keeping 75% covered leaves XXXX SNPs (too many?)
