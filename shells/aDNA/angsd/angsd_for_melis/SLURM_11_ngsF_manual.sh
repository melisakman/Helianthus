...
mkdir ${Project_name}_1_EM_start
cd ${Project_name}_1_EM_start
...
/global/home/users/nwales/programs/ngsF/ngsF --init_values r --min_epsilon 1e-8 \
--approx_EM --n_ind ${number_of_samples} --n_sites ${number_of_sites} --glf ${Project_name}.glf \
--out ${Project_name}_1_EM_start.ngsF --n_threads ${SLURM_CPUS_PER_TASK}

cd ..


mkdir ${Project_name}_2_approx_start
cd ${Project_name}_2_approx_start
cp ${angsd_directory}/${Project_name}.glf.gz . 
gunzip ${Project_name}.glf.gz
...
cp /global/scratch/nwales/Sunflower_paleomix/Alred_paper/11_ngsF/${Project_name}_1_EM_start/${Project_name}_1_EM_start.ngsF.pars .

/global/home/users/nwales/programs/ngsF/ngsF --init_values ${Project_name}_1_EM_start.ngsF.pars --min_epsilon 1e-9 \
--n_ind ${number_of_samples} --n_sites ${number_of_sites} --glf ${Project_name}.glf \
--out ${Project_name}_2_approx_start.ngsF --n_threads ${SLURM_CPUS_PER_TASK}
