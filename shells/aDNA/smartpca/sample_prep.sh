...
bcftools concat dom_angsd_capture_sorted.vcf.gz neut_angsd_capture_sorted.vcf.gz | /clusterfs/rosalind/users/makman/tabix-0.2.6/bgzip -c > neut_dom_angsd_capture_sorted.vcf.gz
