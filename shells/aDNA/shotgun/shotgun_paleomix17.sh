...
paleomix bam_pipeline run /global/home/users/makman/git/Helianthus/shells/aDNA/shotgun/shotgun_paleomix17.yml --max-threads 24 --bwa-max-threads 24 --jre-option -Xmx64g --temp-root=/global/scratch/users/makman/temp/ --destination=/global/scratch/users/makman/Sunflower_paleomix_new/shotgun
